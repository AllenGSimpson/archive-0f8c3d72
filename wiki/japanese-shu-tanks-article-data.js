...
Object.assign(window.deepArticles, {
  "type-16-shu-ha": japaneseShuTankArticle({
    ...
    lead:"The Type 16 Shu-Ha is Japan's first main battle tank and the first production vehicle of the Shu main-force lineage. Adopted in 1956, it combines a 90 mm gun, compact diesel power, optical rangefinding, four-person operation, and protection against common medium-caliber weapons in a 36-tonne vehicle.<sup class='canon-note' data-provenance='a'>[a]</sup> Its suitability for maritime transport, restricted bridges, narrow roads, and dispersed imperial service follows the wider Japanese design doctrine rather than a fixed vehicle-level transport specification.<sup class='canon-note' data-provenance='e'>[e]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-m3u8q writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The Type 16 designation, Shu-Ha identity, first-cycle development position, 1956 introduction, 36.0-tonne weight, four-person crew, 90 mm Type 16 L/55 gun, 750 hp diesel, 55 km/h road speed, principal design character, 1962 Kai modernization, and limited Azad Hind service during the Northern Indian War are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturer, dimensions, armor thickness, ammunition stowage, secondary armament, production total, Japanese unit list, trial chronology, detailed transport limits, and complete combat history remain open; calculated power-to-weight performance and broader logistical consequences are compatible extrapolations.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "type-26-shu-he": japaneseShuTankArticle({
    ...
    lead:"The Type 26 Shu-He is the second production tank of Japan's Shu main-force lineage. Entering service in 1966, it introduces hydropneumatic suspension, two-axis stabilization, active-infrared night equipment, and analog ballistic correction around a 105 mm gun, four-person crew, and 40.5-tonne chassis.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-n6h2r writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The Type 26 designation, Shu-He identity, second-cycle development position, 1966 introduction, 40.5-tonne weight, four-person crew, 105 mm Type 26 L/52 gun, 850 hp diesel, 62 km/h road speed, hydropneumatic suspension, two-axis stabilization, active infrared equipment, analog ballistic correction, and 1971 Kai modernization are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturer, dimensions, armor values, ammunition load, secondary weapons, production total, unit list, export record, combat history, and later reserve or retirement chronology remain open; calculated power-to-weight performance and the article's logistical consequences are compatible extrapolations.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "type-36-shu-ri": japaneseShuTankArticle({
    ...
    lead:"The Type 36 Shu-Ri is the third production tank of Japan's Shu main-force lineage and the mature Japanese service tank of the early 1980s. Introduced in 1976, it combines a long 105 mm gun, laser ranging, passive low-light observation, an analog-digital ballistic computer, ceramic-enhanced spaced armor, hydropneumatic running gear, and a 1,000 hp diesel in a 44-tonne four-person vehicle.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-p4k7s writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The Type 36 designation, Shu-Ri identity, third-cycle development position, 1976 introduction, 44.0-tonne weight, four-person crew, 105 mm Type 36 L/60 gun, 1,000 hp diesel, 70 km/h road speed, laser rangefinder, passive low-light sight, analog-digital ballistic computer, ceramic-enhanced spaced armor, 1981 Kai, 1984 Kai Ni, and position during the Type 45 transition are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturer, dimensions, armor values, armor-array construction, ammunition stowage, secondary armament, production totals, unit list, export record, and complete combat history remain open; calculated power-to-weight performance and detailed crew or logistics consequences are compatible extrapolations.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
