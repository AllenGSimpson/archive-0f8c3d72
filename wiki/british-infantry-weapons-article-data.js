...
Object.assign(window.deepArticles, {
  "british-infantry-weapons": britishInfantryArticle({
    ...
    lead:"Britain's postwar infantry-weapons system is built around the 7×43 mm <a href='rifle-no-9.html'>Rifle No. 9</a> bullpup and the belt-fed <a href='l4-taden.html'>L4</a> and <a href='l7-taden.html'>L7 TADEN</a> machine guns. Indian service exposes the young family to dust, monsoon rain, heat, poor roads, and irregular maintenance; later marks improve manufacture, reliability, optics, and accessories without abandoning the common cartridge.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-e7u3b writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The six registered weapon marks, introduction dates, 7×43 mm cartridge, feed systems, roles, Mk 1's identity as the service EM-2, Mk 4 equipment, Enfield Dovetail Pattern 76, Indian proving-ground role, post-1978 4.85×49 mm trials, and non-adoption before 1985 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Designers, manufacturers, mechanisms, dimensions, mass, rates of fire, production totals, issue scales, exports, losses, and post-1985 succession remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "rifle-no-9": britishInfantryArticle({
    ...
    lead:"Rifle No. 9 is Britain's 7×43 mm bullpup service-rifle family, adopted as the service EM-2 in 1951. Mk 2 improves reliability and manufacture in 1962, while Mk 4 adds modern furniture and sighting interfaces in 1977 and remains the principal British service rifle in 1985.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-f4v8c writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The family name, Mk 1's identity as service EM-2, three registered marks, introduction dates, 7×43 mm cartridge, magazine capacities, roles, Mk 4 polymer furniture, passive night-sight interface, 4× marksman optic, optional 40×46 mm underbarrel launcher, Indian proving-ground use, and principal 1985 status are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Mechanism, dimensions, mass, barrel, sights, production, units, exports, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "l4-taden": britishInfantryArticle({
    ...
    lead:"L4 TADEN is Britain's 7×43 mm bipod light machine gun, introduced in 1952 with a 50-round belt. It supplies mobile automatic fire within the same cartridge system as Rifle No. 9 while the heavier <a href='l7-taden.html'>L7 TADEN</a> serves general-purpose, tripod, and vehicle roles.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-g9w5d writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The designation, 1952 introduction, 7×43 mm cartridge, 50-round-belt feed, bipod light-machine-gun role, relationship to L7, and Indian field evaluation are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Designer, manufacturer, mechanism, dimensions, mass, barrel, rate of fire, belt links, production, units, mounts, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "l7-taden": britishInfantryArticle({
    ...
    lead:"L7 TADEN is Britain's 7×43 mm general-purpose machine-gun family, introduced in 1954 with a 100-round belt for general-purpose and tripod work. L7A4 follows in 1974 with an improved barrel, feed system, and optical fire-control package, and the family also arms British vehicles including FV432.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-h2x7f writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The L7 and L7A4 designations, introduction dates, 7×43 mm cartridge, 100-round belt, registered roles and improvements, Indian field evaluation, and FV432 armament use are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Mechanism, dimensions, mass, barrel details, rate of fire, belt links, optical components, production, units, other mounts, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "enfield-dovetail-pattern-76": britishInfantryArticle({
    ...
    lead:"Enfield Dovetail Pattern 76 is Britain's standard optical mounting interface for infantry weapons. Adopted as a national dovetail standard rather than a universal rail, it supports the mature Rifle No. 9 and TADEN sighting system while remaining distinct from German, Japanese, Latin, and later international interfaces.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-j8y4g writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The name, British standard status, 1976 designation year, optical-mounting purpose, use with the mature British infantry-weapons system, and explicit non-Picatinny identity are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Geometry, dimensions, locking method, allowable loads, accessories, manufacturers, compatibility list, patent history, and later replacement remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "british-4-85-mm-trials": britishInfantryArticle({
    ...
    lead:"The British 4.85 mm trials are the post-1978 experimental program examining 4.85×49 mm infantry weapons as a possible successor to the entrenched 7×43 mm Rifle No. 9 and TADEN system. The trials do not produce service adoption before 1985.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-k5z9h writer=g kind=revision created=2026-08-15T20:30:00-06:00 -->The post-1978 timing, 4.85×49 mm caliber, trial status, consideration as a successor to 7×43 mm, and non-adoption before 1985 because the existing system remains effective and logistically entrenched are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Program title, weapons, designers, manufacturers, mechanism, ammunition performance, quantities, units, results, cancellation date, and post-1985 outcome remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
...
const britishInfantrySystemArticle = window.deepArticles["british-infantry-weapons"];
if (britishInfantrySystemArticle && !britishInfantrySystemArticle.sections.some(section => section.id === "wartime-ancestry")) {
  britishInfantrySystemArticle.sections.unshift({
    id:"wartime-ancestry",
    title:"Wartime ancestry",
    html:"<p>The postwar system followed a wartime force that had retained a <a href='british-wartime-rifle-platoon.html'>three-section Bren-centered rifle platoon</a> while improving close antitank provision, communications, and access to supporting arms. The overlapping use of Boys rifles, PIATs, and Lend-Lease bazookas is covered in the <a href='british-wartime-close-antitank-system.html'>wartime close-antitank system</a>.</p>"
  });
}
addBritishInfantryRelation("british-infantry-weapons", {href:"british-wartime-rifle-platoon.html",kicker:"Wartime organizational ancestor",label:"British Wartime Rifle Platoon"});
addBritishInfantryRelation("british-infantry-weapons", {href:"british-wartime-close-antitank-system.html",kicker:"Wartime support weapons",label:"British Wartime Close-Antitank System"});
