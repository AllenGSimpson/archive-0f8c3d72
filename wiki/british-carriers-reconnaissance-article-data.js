...
Object.assign(window.deepArticles, {
  "british-carriers-and-reconnaissance": britishCarrierArticle({
    ...
    lead:"Britain's postwar light-armour system combines the <a href='fv432.html'>FV432</a> personnel carrier, cannon-armed <a href='fv435-cavalier.html'>FV435 Cavalier</a>, missile-carrying <a href='fv438-swingfire.html'>FV438 Swingfire</a>, and the compact CVR(T) pair of <a href='fv101-scorpion.html'>FV101 Scorpion</a> and <a href='fv107-scimitar.html'>FV107 Scimitar</a>. The larger <a href='fv510-warrior.html'>FV510 Warrior</a> enters troop trials in 1985 but does not join the Falklands force.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-p4b8j writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The six registered vehicles, introduction dates, weights, crews, armaments, broad roles, Cavalier's FV430-family basis and rear door, its omission of firing ports, CVR(T)'s low ground pressure and transport value, Swingfire's British carrier integration, Warrior's trials-only status, and the five Falklands theater totals are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, armor, engine and speed data, ammunition loads, procurement totals, organizations, daily readiness, losses, and post-1985 development remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv432": britishCarrierArticle({
    ...
    lead:"FV432 Mk 1 is Britain's standard tracked personnel carrier from 1963. The 15.3-tonne vehicle carries a crew of two and ten infantry, and its automotive family supplies the basis for specialized British carriers including <a href='fv438-swingfire.html'>FV438 Swingfire</a> and <a href='fv435-cavalier.html'>FV435 Cavalier</a>.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-q7c2k writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The Mk 1 designation, 1963 introduction, 15.3-tonne weight, crew of two plus ten infantry, 7 mm L7 TADEN, standard tracked-carrier role, FV430-family relationship, and Falklands family total of 36 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, protection, engine, speed, range, amphibious equipment, production, variants, unit allocations, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv435-cavalier": britishCarrierArticle({
    ...
    lead:"FV435 Cavalier is Britain's first-generation cannon-armed infantry fighting vehicle, introduced in 1972. It combines FV430-family automotive components with a 30 mm RARDEN, coaxial 7 mm weapon, rear troop door, and space for six infantry, giving the Army a deployed IFV more than a decade before <a href='fv510-warrior.html'>Warrior</a> troop trials.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-r3d6m writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The designation, 1972 introduction, 18.2-tonne weight, crew of three plus six infantry, 30 mm RARDEN and coaxial 7 mm armament, FV430-family automotive basis, rear door, omission of firing ports, cramped and imperfect character, first-generation IFV role, and Falklands total of 12 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Armor, dimensions, engine, speed, turret mechanics, ammunition load, procurement total, units, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv438-swingfire": britishCarrierArticle({
    ...
    lead:"FV438 Swingfire is Britain's FV430-family long-range antitank carrier, introduced in 1969. Its three-person crew operates four ready Swingfire missiles, supplying guided antitank fire beside tanks, infantry carriers, and compact CVR(T) reconnaissance vehicles.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-s9f5n writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The designation, 1969 introduction, 16.2-tonne weight, crew of three, four ready Swingfire missiles, long-range antitank role, British carrier-family integration, wider use of Swingfire on CVR(T)-derived vehicles, exclusion of an American carrier basis, and Falklands total of eight FV438s are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Missile range, guidance details, penetration, reload stowage, armor, engine, speed, procurement, units, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv101-scorpion": britishCarrierArticle({
    ...
    lead:"FV101 Scorpion is a British CVR(T) light reconnaissance and fire-support vehicle introduced in 1971. Its three-person crew operates a 76 mm L23 in an 8.1-tonne tracked vehicle whose low ground pressure, compact dimensions, and transportability suit Commonwealth and expeditionary service.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-t2g7p writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The designation, 1971 introduction, 8.1-tonne weight, crew of three, 76 mm L23, reconnaissance and fire-support role, CVR(T) qualities, and Falklands total of 12 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Armor, dimensions, engine, road speed, range, ammunition load, sights, procurement, national users, units, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv107-scimitar": britishCarrierArticle({
    ...
    lead:"FV107 Scimitar is Britain's 30 mm CVR(T) reconnaissance vehicle, introduced in 1971. The 8.0-tonne, three-person vehicle combines RARDEN armament with the low ground pressure, compact dimensions, and transportability that make the CVR(T) family central to Commonwealth expeditionary reconnaissance.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-u8h4q writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The designation, 1971 introduction, 8.0-tonne weight, crew of three, 30 mm RARDEN in 30×170 mm, tracked reconnaissance role, CVR(T) qualities, and Falklands total of 24 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Armor, dimensions, engine, speed, range, ammunition, sensors, procurement, national users, organization, and losses remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "fv510-warrior": britishCarrierArticle({
    ...
    lead:"FV510 Warrior is Britain's 25.4-tonne next-generation infantry fighting vehicle in pre-production and troop trials during 1985. It carries a crew of three, seven infantry, and a 30 mm RARDEN, but it is not yet a normal service vehicle and does not deploy to the Falklands War.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-v5j9r writer=g kind=revision created=2026-08-15T20:20:00-06:00 -->The designation, 1985 troop-trial status, 25.4-tonne weight, crew of three plus seven infantry, 30 mm RARDEN in 30×170 mm, pre-production fleet boundary, and absence from the Falklands are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Formal service date, production total, engine, speed, dimensions, armor, equipment, unit assignment, trial results, and post-1985 variants remain open in the setting.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
