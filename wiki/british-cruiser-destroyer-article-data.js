...
const britishCruiserDestroyerCanon = "<sup class='canon-note' data-provenance='a'>[a]</sup>";
const britishCruiserDestroyerHistory = "<sup class='canon-note' data-provenance='p'>[p]</sup>";
const britishCruiserDestroyerExtrapolation = "<sup class='canon-note' data-provenance='e'>[e]</sup>";
...
Object.assign(window.deepArticles, {
  "british-cruiser-force": britishNavalArticle({
    ...
    lead:"British postwar cruisers supplied command, air defense, aviation, anti-ship weapons, and medium-caliber gunfire to the route-defense fleet. The current incorporated reconstruction uses three Tiger-class command cruisers and eight County-class guided-missile cruisers, with two Tigers and five Counties active in 1985.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc1a2 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes the cruiser as a command-and-control platform for dispersed groups, with helicopters, long-range communications, and useful air-defense and ASW capacity.${britishCruiserDestroyerCanon} The Tiger and County classes, build totals, dates, displacements, rosters, name substitutions, and seven-ship 1985 balance are incorporated reconstruction whose exact postwar register remains provisional.${britishCruiserDestroyerExtrapolation} The South Atlantic County-name discrepancy remains unresolved.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "tiger-class-command-cruiser": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"In the current incorporated reconstruction, the Tiger class comprised HMS Tiger, HMS Blake, and HMS Hawke. The three 13,800-tonne ships entered service between 1954 and 1958 with automatic 152 mm guns, fleet-command facilities, helicopter aviation, and area-defense weapons; Tiger and Blake remained active in 1985 and Hawke was in mobilization reserve.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc2b3 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes a British cruiser command layer coordinating dispersed naval groups and supporting aviation, communications, air defense, and ASW.${britishCruiserDestroyerCanon} Tiger's three-ship roster, commissioning years, displacement, steam propulsion, automatic-gun fit, and 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} Detailed design and individual service histories remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "county-class-guided-missile-cruiser": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"In the current incorporated reconstruction, the County class comprised eight British guided-missile cruisers introduced between 1962 and 1972. Each displaced 13,200 tonnes at full load and served in task-group air defense, command, anti-ship attack, and anti-submarine aviation; five ships remained active in 1985.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc3c4 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes a British cruiser command layer with long-range communications, helicopters, air defense, and useful ASW capacity.${britishCruiserDestroyerCanon} County's eight-ship roster, commissioning years, displacement, propulsion, weapons categories, aviation allocation, decommissioning dates, name substitutions, and 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} The separate South Atlantic name discrepancy remains unresolved.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "british-destroyer-force": britishNavalArticle({
    ...
    category:"Naval history",
    landscape:britishLineageLandscape,
    lead:"The British postwar destroyer force carried fleet air defense and useful anti-submarine equipment within the route-defense system. The current incorporated reconstruction develops this branch from radar-directed Battle-class gun ships through missile-rebuilt Darings to Bristol and Sheffield missile classes, with twenty-eight destroyers active in 1985.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc4d5 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes the destroyer as a dual-purpose fleet escort emphasizing air defense while retaining useful ASW equipment.${britishCruiserDestroyerCanon} The Battle–Daring–Bristol–Sheffield sequence, build totals, introduction bands, displacements, rosters, and twenty-eight-ship 1985 balance are incorporated reconstruction whose exact postwar register remains provisional.${britishCruiserDestroyerExtrapolation} Detailed design, refits, readiness, deployments, and individual histories remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "battle-class-destroyer": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Battle class originated during the war as a British radar-directed gun-defense destroyer. In the current incorporated reconstruction it became a twenty-four-ship class introduced between 1944 and 1950, served through the first three postwar decades, and had left active service by 1985.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc5e6 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->The wartime Battle-class program and radar-directed gun-defense purpose are grounded in inherited pre-divergence development and the established extended war.${britishCruiserDestroyerHistory} The twenty-four-ship completion, roster, later commissioning and decommissioning years, displacement, propulsion, and zero-active 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} Unfixed design and service details remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "daring-class-destroyer": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"In the current incorporated reconstruction, the Daring class was a sixteen-ship British large-destroyer class introduced between 1949 and 1957. Eight ships received missile reconstruction and remained active in 1985, linking the postwar gun fleet to the later purpose-built missile force.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc6f7 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes a British destroyer branch centered on fleet air defense and useful ASW capacity.${britishCruiserDestroyerCanon} Daring's class identity, sixteen-ship roster, dates, displacement, propulsion, missile reconstruction, and 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} Detailed design, refit, deployment, and individual histories remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "bristol-class-destroyer": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"In the current incorporated reconstruction, the Bristol class comprised the heavy fleet-air-defense destroyers HMS Bristol, HMS Bath, HMS Winchester, and HMS Portsmouth. The class occupied the 1963–1970 introduction band, displaced 7,600 tonnes at full load, and retained all four ships in active service in 1985.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc7g8 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes a heavy British fleet-air-defense requirement within the destroyer branch.${britishCruiserDestroyerCanon} Bristol's class identity, four-ship roster, commissioning years, introduction band, displacement, propulsion, and 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} Detailed design, deployment, and individual histories remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
  ...
  "sheffield-class-destroyer": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"In the current incorporated reconstruction, the Sheffield class was a sixteen-ship British missile-destroyer class introduced between 1974 and 1985. All sixteen 4,900-tonne ships remained active at the reference date and formed the Royal Navy's standard missile-destroyer generation.",
    canon:`<!-- altwwii-writer-block:start id=wb-g-20260816-bc8h9 writer=g kind=revision created=2026-08-16T16:00:00-06:00 -->Later naval doctrine establishes a numerous British missile-destroyer branch centered on fleet air defense and useful ASW support.${britishCruiserDestroyerCanon} Sheffield's class identity, sixteen-ship roster, commissioning years, displacement, and 1985 balance are incorporated reconstruction whose exact register remains provisional.${britishCruiserDestroyerExtrapolation} Propulsion, detailed design, deployment, and individual histories remain open.<!-- altwwii-writer-block:end -->`,
    sections:[
