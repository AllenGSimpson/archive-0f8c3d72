...
Object.assign(window.deepArticles, {
  "hawker-aircraft": britishDesignHouseArticle({
    ...
    sections:[
      ...
      {id:"field-reports",title:"Field reports and engineering action",html:"<!-- altwwii-writer-block:start id=wb-v-20260816-d8r4m writer=v kind=extrapolation created=2026-08-16T14:20:36-06:00 --><p>An overseas unit or depot reporting a Hunter fault identified the airframe and installed equipment, the operating conditions, the observed symptom, previous maintenance, any temporary action, and parts removed when those facts were available. Customer representatives and technical missions passed the report to Hawker, which separated airframe questions from engine, radar, weapon, instrument, and manufacturing responsibilities before asking the relevant partner for an answer.</p><p>An isolated fault might produce repair advice or a request for the component. A repeated or safety-relevant condition could lead to an inspection instruction, amended maintenance practice, replacement kit, drawing change, or additional training after engineering review and test. Customers sometimes made local modifications, lacked complete records, or disagreed with a supplier over responsibility and cost. Field experience entered the design system through this uneven process rather than becoming an immediate fleet-wide change.</p><!-- altwwii-writer-block:end -->"},
