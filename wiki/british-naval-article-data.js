...
Object.assign(window.deepArticles, {
  ...
  "british-armistice-fleet": britishNavalArticle({
    ...
    sections:[
      ...
      {id:"capital",title:"Capital ships",html:"<p>The eleven ships were <em>Hood</em>, <em>Renown</em>, <em>Nelson</em>, <em>Rodney</em>, <em>Queen Elizabeth</em>, <em>Valiant</em>, <em>King George V</em>, <em>Duke of York</em>, <em>Anson</em>, <em>Howe</em>, and <em>Vanguard</em>. <em>Hood</em> survived because the Denmark Strait action did not occur, although structural exhaustion forced retirement in 1950.</p><p><em>Prince of Wales</em> and <em>Repulse</em> remained Far Eastern losses. Eight of the eleven surviving capital ships were operational.</p>"},
      {id:"carriers-cruisers",title:"Carriers and cruisers",html:"<p>Fourteen of twenty-four fleet and light carriers and twenty-nine of forty-three cruisers were operational. The remainder included ships under repair, incomplete work-ups, reserve hulls, and vessels approaching retirement.</p>"},
      {id:"escorts",title:"Destroyers and major escorts",html:"<p>Britain retained 168 destroyers and 260 frigates, corvettes, and other major escorts afloat. Of these, 112 destroyers and 180 major escorts were operational. Convoy protection and the continuing maritime war had kept production and repair active through the settlement.</p>"},
      {id:"submarines",title:"Submarine force",html:"<p>Forty-eight of seventy-four submarines were operational. Repair boats, training hulls, reserve vessels, obsolete types, and boats awaiting disposition accounted for the difference.</p>"},
      {id:"attrition",title:"Wartime attrition",html:"<p>Britain lost 175 destroyers and ninety-five submarines during the extended war. Completion and American or Commonwealth transfer programs left the surviving destroyer and escort force large in number but uneven in age and material condition.</p>"},
      ...
      {id:"registry",title:"Registry reconstruction",html:"<p>The aggregate totals and eleven capital-ship names are fixed. Individual survival among most carriers, cruisers, escorts, and submarines is reconstructed by class allocation. Service names and pennants are retained where possible; extrapolated completions extend period naming families and carry a registry notice.</p>"},
    ...
    facts:[["Reference date","31 December 1947"],["Capital ships afloat / operational","11 / 8"],["Carriers afloat / operational","24 / 14"],["Cruisers afloat / operational","43 / 29"],["Destroyers afloat / operational","168 / 112"],["Major escorts afloat / operational","260 / 180"],["Submarines afloat / operational","74 / 48"],["Wartime destroyer losses","175"],["Wartime submarine losses","95"],["Operational major combatants and submarines","391"]],
