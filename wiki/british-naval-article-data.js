...
Object.assign(window.deepArticles, {
  "royal-navy-postwar": britishNavalArticle({
    ...
    canon:"The revised 1947 inheritance, strategic priorities, naming system, Cape-route role, Kuwait and Falklands employment, German submarine threat, and premier surface, aviation, anti-submarine, and support position are established. Four principal fleet carriers and three light or assault carriers are the current 1985 working allocation; final worldwide totals outside fixed theatre pools remain open.",
    sections:[
      {id:"inheritance",title:"Armistice inheritance",html:"<!-- altwwii-writer-block:start id=wb-g-20260815-k9p6c writer=g kind=revision created=2026-08-15T12:54:00-06:00 --><p>Britain ended 1947 with ten capital ships, twenty-six fleet, light, or escort carriers, thirty-four cruisers, 134 destroyers, 204 major escorts, and sixty-two submarines afloat. Seven capital ships, fifteen carriers, twenty-three cruisers, seventy-eight destroyers, 122 escorts, and forty-two submarines were operational.</p><p>The inventory was large because Britain had fought a long maritime war and continued building replacements. It also contained damaged, exhausted, second-line, and rapidly obsolescent ships.</p><!-- altwwii-writer-block:end -->"},
      ...
      {id:"reconstruction",title:"Postwar reconstruction",html:"<p>The emergency fleet contracted while dockyards preserved carrier, radar, sonar, nuclear-propulsion, escort, and amphibious skills. By 1985 four principal fleet carriers and three light or assault carriers formed the current working allocation within a premier Commonwealth surface, aviation, anti-submarine, and support system. Exact worldwide destroyer, frigate, submarine, amphibious, mine, and auxiliary totals remain open outside separately fixed theatre pools.</p>"},
      ...
      {id:"1985",title:"Fleet in 1985",html:"<p>The revised 1985 position is relational rather than a complete global hull ledger. Britain and the Commonwealth maintained premier surface, aviation, anti-submarine, and support capabilities; four principal fleet carriers and three light or assault carriers are the current working allocation. Fixed theatre pools remain valid where separately established, but final worldwide totals are open.</p>"},
    ...
    related:[{href:"world-naval-balance-1985.html",kicker:"Comparative strength",label:"World Naval Balance in 1985"},{href:"naval-armistice-inventory-1947.html",kicker:"Starting inventory",label:"Naval Armistice Inventory of 1947"},{href:"portsmouth.html",kicker:"Principal Channel base",label:"Portsmouth"},{href:"siege-commonwealth-naval-system.html",kicker:"Strategic network",label:"Siege Commonwealth Naval System"},{href:"british-fleet-carriers.html",kicker:"Air power",label:"British Fleet-Carrier Force"},{href:"royal-navy-submarine-force.html",kicker:"Undersea arm",label:"Royal Navy Submarine Force"}],
    facts:[["Service","Royal Navy"],["Strategic route","Atlantic–Cape–Indian Ocean"],["1947 capital ships afloat / operational","10 / 7"],["1947 carriers afloat / operational","26 / 15"],["1985 carrier allocation","4 fleet · 3 light/assault (working)"],["Other worldwide 1985 totals","Open outside fixed theatre pools"],["Reference date","1 January 1985"]]
  }),
  ...
  "british-armistice-fleet": britishNavalArticle({
    ...
    canon:"The revised afloat and operational totals, ten named capital ships, Hood's pre-divergence loss, the losses of Prince of Wales, Repulse, Warspite, and Barham, the carrier-type breakdown, and registry reconstruction rules are established. Exact wartime destroyer and submarine attrition and most individual escort, cruiser, carrier, and submarine service histories remain open or working allocations.",
    sections:[
      {id:"balance",title:"Balance on 31 December 1947",html:"<!-- altwwii-writer-block:start id=wb-g-20260815-m4t7v writer=g kind=revision created=2026-08-15T12:54:00-06:00 --><div class='table-wrap'><table class='wiki-table'><thead><tr><th>Category</th><th>Afloat</th><th>Operational</th></tr></thead><tbody><tr><td>Capital ships</td><td>10</td><td>7</td></tr><tr><td>Fleet, light, and escort carriers</td><td>26</td><td>15</td></tr><tr><td>Cruisers</td><td>34</td><td>23</td></tr><tr><td>Destroyers</td><td>134</td><td>78</td></tr><tr><td>Frigates, corvettes, and major escorts</td><td>204</td><td>122</td></tr><tr><td>Submarines</td><td>62</td><td>42</td></tr></tbody></table></div><!-- altwwii-writer-block:end -->"},
      {id:"capital",title:"Capital ships",html:"<p>The ten ships were <em>Renown</em>, <em>Nelson</em>, <em>Rodney</em>, <em>Queen Elizabeth</em>, <em>Valiant</em>, <em>King George V</em>, <em>Duke of York</em>, <em>Anson</em>, <em>Howe</em>, and <em>Vanguard</em>. Seven were operational.</p><p><em>Hood</em> was lost before the divergence. <em>Prince of Wales</em> and <em>Repulse</em> remained Far Eastern losses, <em>Warspite</em> was lost at Ceylon, and <em>Barham</em> retained her historical 1941 loss.</p>"},
      {id:"carriers-cruisers",title:"Carriers and cruisers",html:"<p>The twenty-six carriers comprised six fleet, seven light, and thirteen escort carriers afloat; four, four, and seven respectively were operational. Twenty-three of thirty-four cruisers were operational.</p>"},
      {id:"escorts",title:"Destroyers and major escorts",html:"<p>Britain retained 134 destroyers and 204 frigates, corvettes, and other major escorts afloat. Of these, seventy-eight destroyers and 122 major escorts were operational. Convoy protection and the continuing maritime war had kept production and repair active through the settlement.</p>"},
      {id:"submarines",title:"Submarine force",html:"<p>Forty-two of sixty-two submarines were operational. Repair boats, training hulls, reserve vessels, obsolete types, and boats awaiting disposition accounted for the difference.</p>"},
      {id:"attrition",title:"Wartime attrition",html:"<p>Completion, repair, and American or Commonwealth transfer programs left the surviving destroyer and escort force large in number but uneven in age and material condition. Exact cumulative destroyer and submarine loss totals remain open pending reconciliation with the revised inheritance.</p>"},
      {id:"condition",title:"Material condition",html:"<p>Afloat did not mean ready for combat. Damage, machinery wear, incomplete training, repair queues, obsolete sensors, aircraft shortages, and crew shortages separated the physical inventory from the operational fleet.</p>"},
      {id:"registry",title:"Registry reconstruction",html:"<p>The revised aggregate totals and ten capital-ship names are controlling. Individual survival among most carriers, cruisers, escorts, and submarines is reconstructed by class allocation. Service names and pennants are retained where possible; extrapolated completions extend period naming families and carry a registry notice.</p>"},
      {id:"reduction",title:"Reduction after 1947",html:"<p>Reduction supplied reserve ships, exports, test platforms, training hulks, machinery, and scrap. Active formations retained the ships that could support carrier aviation, anti-submarine warfare, amphibious movement, and the Atlantic–Cape route.</p>"},
      {id:"legacy",title:"Postwar use",html:"<p>The armistice fleet preserved dockyards, naval aviation, escort experience, and trained personnel. Its replacement created the specialized carrier, missile, anti-submarine, nuclear-submarine, and auxiliary fleet of 1985.</p>"}
    ],
    related:[{href:"naval-armistice-inventory-1947.html",kicker:"Five-navy comparison",label:"Naval Armistice Inventory of 1947"},{href:"royal-navy-postwar.html",kicker:"Successor fleet",label:"Postwar Royal Navy"},{href:"lion-class-missile-battleship.html",kicker:"New capital generation",label:"Lion Class"},{href:"british-fleet-carriers.html",kicker:"Carrier reconstruction",label:"British Fleet-Carrier Force"},{href:"siege-commonwealth-naval-system.html",kicker:"Postwar network",label:"Siege Commonwealth Naval System"},{href:"lisbon-conference.html",kicker:"Political settlement",label:"Lisbon Conference"}],
    facts:[["Reference date","31 December 1947"],["Capital ships afloat / operational","10 / 7"],["Carriers afloat / operational","26 / 15"],["Cruisers afloat / operational","34 / 23"],["Destroyers afloat / operational","134 / 78"],["Major escorts afloat / operational","204 / 122"],["Submarines afloat / operational","62 / 42"],["Carrier breakdown afloat","6 fleet · 7 light · 13 escort"],["Named capital survivors","10"]],
  ...
  "lion-class-missile-battleship": britishNavalArticle({
    ...
    sections:[
      {id:"construction",title:"Construction",html:"<p><em>Lion</em> commissioned in 1949 and <a href='hms-temeraire.html'>HMS <em>Temeraire</em></a> in 1952. The class carried forward the Royal Navy's prewar 406 mm fast-battleship design work into the extended-war industrial program.</p>"},
    ...
    related:[{href:"hms-temeraire.html",kicker:"Individual ship",label:"HMS Temeraire"},{href:"royal-navy-postwar.html",kicker:"Parent service",label:"Postwar Royal Navy"},{href:"british-fleet-carriers.html",kicker:"Task-group partners",label:"British Fleet Carriers"},{href:"british-cruiser-force.html",kicker:"Missile screen",label:"British Cruiser Force"},{href:"falklands-war.html",kicker:"1985 operation",label:"Falklands/Malvinas War"}],
  ...
  "british-cruiser-force": britishNavalArticle({
    ...
    sections:[
      ...
      {id:"names",title:"Names",html:"<p>Dorset, Surrey, and Middlesex were selected because surviving prewar County cruisers still carried the names Devonshire, Kent, and London when the missile ships commissioned.</p>"},
