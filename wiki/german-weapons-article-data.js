...
Object.assign(window.deepArticles, {
  "german-postwar-small-arms": germanWeaponArticle({
    ...
    lead:"German postwar small arms developed from the wartime assault-rifle and universal-machine-gun systems into a mixed 5.6 mm and 7.92 mm establishment. By 1985 the StG 60 remained the ordinary service rifle, the Gewehr 58 and MG 68 retained the full-power 7.92×57 mm cartridge, and the StG 82 equipped selected elite units.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-g2d7m writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The registered weapons, dates, cartridges, feeds, standard roles, principal StG 60 specifications, StG 82 features, export designations, and Einheitsleiste 79 interface are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturers, production totals, unit-by-unit issue, detailed variants other than the StG 60A6 adapter, and retirement dates remain open.<sup class='canon-note' data-provenance='e'>[e]</sup> Proposed Congo-era StG 60A3/A4 changes, Granatgerät 74, and Tragschiene 75 are not registered service equipment.<sup class='canon-note' data-provenance='a'>[a]</sup><!-- altwwii-writer-block:end -->",
    sections:[
      {id:"wartime",title:"Wartime inheritance",html:"<p>The <a href='stg-44.html'>StG 44</a> entered service in 1944 with a 30-round magazine and the intermediate 7.92×33 mm cartridge. The <a href='stg-45a.html'>StG 45A</a> followed in 1945 as a simplified postwar rifle and export standard. It was a gas-operated, stamped-steel reliability development of the StG 44 rather than the roller-delayed StG 45(M).</p><p>Separate Gerät 06 roller-delayed work survived the war and informed the later <a href='gewehr-58.html'>Gewehr 58</a> and machine-gun engineering. The distinction is retained in the controlling registry.</p>"},
    ...
    related:[{href:"stg-44.html",kicker:"Wartime assault rifle",label:"StG 44"},{href:"stg-45a.html",kicker:"Postwar export rifle",label:"StG 45A"},{href:"mg-42.html",kicker:"Wartime universal weapon",label:"MG 42"},{href:"mg-52.html",kicker:"Early postwar GPMG",label:"MG 52"},{href:"stg-60.html",kicker:"Standard 1985 rifle",label:"StG 60"},{href:"mg-68.html",kicker:"Standard 1985 GPMG",label:"MG 68"},{href:"leichtes-mg-76.html",kicker:"Squad automatic weapon",label:"leichtes MG 76"},{href:"einheitsleiste-79.html",kicker:"Mounting standard",label:"Einheitsleiste 79"}],
  ...
  "gewehr-58": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The Gewehr 58 was a German 7.92×57 mm semiautomatic rifle introduced in 1958. It served as a full-power service rifle and designated-marksman weapon alongside the intermediate-cartridge assault-rifle line.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-h4f9p writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The designation, 1958 introduction, 7.92×57 mm cartridge, 20-round magazine, standard roles, and connection to surviving Gerät 06 engineering are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Operating mechanism, dimensions, mass, optics, manufacturer, production total, variants, and unit distribution remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "stg-60": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The StG 60 was the standard German assault rifle from 1961. It fired the 5.6×40 mm cartridge from a 30-round magazine and remained the ordinary service rifle in 1985 despite the introduction of the StG 82 for selected units.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-j6h2r writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The designation, introduction, cartridge, magazine, gas-piston and rotating-bolt action, stamped receiver, 420 mm barrel, 3.7 kg loaded weight, Cuban and Argentine service forms, and StG 60A6 mounting adapter are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturer, production total, overall dimensions, complete variant sequence, and unit issue remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "stg-82": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The StG 82 was a modular German 5.6×40 mm assault rifle introduced in 1983 for elite units. It added polymer furniture, ambidextrous controls, a folding stock, three-round burst, a 40×46 mm grenade launcher, and the Einheitsleiste 79 mounting bar.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-k8j4t writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The designation, 1983 introduction, cartridge, 30-round magazine, listed features, elite-unit role, and non-universal 1985 status are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Action, mass, dimensions, manufacturer, production total, optical suite, named users, and detailed variants remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "mg-68": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The MG 68 was the lighter standard German general-purpose machine gun introduced in 1968. It fired 7.92×57 mm ammunition from a disintegrating belt and continued the universal-machine-gun role of the MG 42 and MG 52.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-m3l7v writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The designation, introduction date, cartridge, disintegrating-belt feed, lighter standard GPMG role, Argentine AA-68 designation, and broad engineering lineage are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Mechanism, mass, barrel length, rate of fire, belt-box capacity, mounts, manufacturer, variants, and production total remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "leichtes-mg-76": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The leichtes MG 76 was a German 5.6×40 mm squad automatic weapon introduced in 1976. It was fed from a 100-round belt box and provided sustained automatic fire using the standard assault-rifle cartridge.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-n5p9x writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The designation, 1976 introduction, cartridge, 100-round belt-box feed, and squad automatic weapon role are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturer, mechanism, dimensions, mass, barrel system, rate of fire, production total, variants, and unit distribution remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "einheitsleiste-79": germanWeaponArticle({
    ...
    landscape:smallArmsLandscape,
    lead:"The Einheitsleiste 79 was the German dovetail-and-cross-slot mounting standard used on late postwar small arms. The StG 82 carried it natively, while upgraded StG 60A6 rifles accepted it through an adapter.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-p7r2z writer=g kind=revision created=2026-08-15T19:35:00-06:00 -->The name, dovetail-and-cross-slot geometry, distinction from Picatinny, native StG 82 use, and StG 60A6 adapter are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Formal adoption date, dimensions, slot pitch, materials, responsible standards office, accessory catalog, and use beyond the named rifles remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "german-antitank-weapons": germanWeaponArticle({
    ...
    lead:"German postwar infantry antitank equipment combined the long-range wire-guided Drachen 66 with the short-range disposable Panzerfaust 74. Both systems entered foreign service, including Argentine formations, while serving different engagement ranges and tactical echelons.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-u4g8x writer=g kind=revision created=2026-08-15T19:30:00-06:00 -->The two registered systems, dates, calibers, guidance or warhead type, effective ranges, penetration, roles, and Argentine service designations are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Manufacturers, weights, complete ammunition families, launch-unit organization, production totals, and the proposed Panzerfaust 74M remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "drachen-66": germanWeaponArticle({
    ...
    landscape:fireSupportLandscape,
    lead:"The Drachen 66 was a German 135 mm wire-guided antitank missile introduced in 1966. Its registered effective range was 3,000 m and its baseline penetration was 600 mm of rolled homogeneous armor.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-v3d7l writer=g kind=revision created=2026-08-15T19:45:00-06:00 -->The designation, introduction, 135 mm caliber, wire guidance, 3,000 m effective range, 600 mm RHA penetration, infantry and vehicle roles, Greif installation, and Argentine Dragón Modelo 70 designation are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Missile mass, launcher design, crew, flight speed, minimum range, warhead details, variants, and production totals remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "panzerfaust-74": germanWeaponArticle({
    ...
    landscape:fireSupportLandscape,
    lead:"The Panzerfaust 74 was a German disposable short-range antitank weapon introduced in 1974. Its 110 mm HEAT projectile had a registered effective range of 400 m and penetration of 650 mm RHA.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-v6j2z writer=g kind=revision created=2026-08-15T19:30:00-06:00 -->The designation, introduction, disposable construction, 110 mm HEAT projectile, 400 m effective range, 650 mm RHA penetration, short-range infantry role, and Argentine Panzerfaust 74A service are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Launcher mass and length, sights, velocity, arming distance, warhead construction, manufacturer, production totals, and proposed 74M variant remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "german-postwar-artillery": germanWeaponArticle({
    ...
    landscape:fireSupportLandscape,
    lead:"German postwar divisional artillery centered on the tracked Panzerhaubitze 55 and Panzerhaubitze 72. Both used the 149.1 mm caliber officially described as 15 cm, while the 1972 model added a longer barrel, powered loading, and an analog fire-direction link.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-x3n7d writer=g kind=revision created=2026-08-15T19:30:00-06:00 -->The registered howitzers, dates, 149.1 mm caliber, official 15 cm terminology, barrel lengths, standard-shell ranges, roles, PzH 72 loading and fire-direction features, and Argentine ammunition and import relationship are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Chassis, mass, crew, engine, armor, rates of fire, production totals, detailed variants, and the proposed Jägerhaubitze 75 remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
      ...
      {id:"pzh55",title:"Panzerhaubitze 55",html:"<p>The <a href='panzerhaubitze-55.html'>Panzerhaubitze 55</a> entered service in 1955 with a 149.1 mm L/30 howitzer. Its registered standard-shell range was 17.5 km. It served as tracked divisional artillery.</p>"},
      {id:"pzh72",title:"Panzerhaubitze 72",html:"<p>The <a href='panzerhaubitze-72.html'>Panzerhaubitze 72</a> entered service in 1972. Its 149.1 mm L/45 howitzer reached 28.0 km with the registered standard shell. Powered loading and an analog fire-direction link distinguished the system in the registry.</p>"},
    ...
    related:[{href:"panzerhaubitze-family.html",kicker:"Equipment family",label:"Panzerhaubitze 55 and 72"},{href:"panzerhaubitze-55.html",kicker:"1955 system",label:"Panzerhaubitze 55"},{href:"panzerhaubitze-72.html",kicker:"1972 system",label:"Panzerhaubitze 72"},{href:"german-flakpanzer-lineage.html",kicker:"Divisional air defense",label:"German Flakpanzer Lineage"},{href:"german-antitank-weapons.html",kicker:"Infantry systems",label:"German Postwar Antitank Weapons"}],
  ...
  "panzerhaubitze-family": germanWeaponArticle({
    ...
    landscape:fireSupportLandscape,
    lead:"The Panzerhaubitze 55 and Panzerhaubitze 72 were Germany's registered postwar tracked divisional howitzers. Both mounted 149.1 mm weapons officially described as 15 cm; the 1972 system increased standard-shell range from 17.5 km to 28.0 km.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-a9u4j writer=g kind=revision created=2026-08-15T19:30:00-06:00 -->The designations, introduction years, caliber, official terminology, barrel lengths, ranges, divisional role, PzH 72 powered loading and analog link, and Argentine relationship are established.<sup class='canon-note' data-provenance='a'>[a]</sup> A direct common chassis lineage is not established, and all vehicle dimensions, mass, crew, propulsion, armor, ammunition capacity, fire rates, production, and variant details remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
      {id:"pzh55",title:"Panzerhaubitze 55",html:"<p>The <a href='panzerhaubitze-55.html'>Panzerhaubitze 55</a> entered service in 1955. It mounted a 149.1 mm L/30 howitzer and had a registered standard-shell range of 17.5 km. Its tracked chassis provided divisional artillery mobility.</p>"},
      {id:"pzh72",title:"Panzerhaubitze 72",html:"<p>The <a href='panzerhaubitze-72.html'>Panzerhaubitze 72</a> entered service in 1972 with a 149.1 mm L/45 howitzer. Standard-shell range was 28.0 km. Powered loading assisted ammunition handling, and an analog link connected the vehicle to fire direction.</p>"},
      {id:"comparison",title:"Comparison",html:"<div class='table-wrap'><table class='wiki-table'><thead><tr><th>System</th><th>Introduction</th><th>Howitzer</th><th>Standard-shell range</th><th>Registered feature</th></tr></thead><tbody><tr><td><a href='panzerhaubitze-55.html'>Panzerhaubitze 55</a></td><td>1955</td><td>149.1 mm L/30</td><td>17.5 km</td><td>Tracked divisional artillery</td></tr><tr><td><a href='panzerhaubitze-72.html'>Panzerhaubitze 72</a></td><td>1972</td><td>149.1 mm L/45</td><td>28.0 km</td><td>Powered loading; analog fire-direction link</td></tr></tbody></table></div>"},
    ...
    related:[{href:"panzerhaubitze-55.html",kicker:"First postwar model",label:"Panzerhaubitze 55"},{href:"panzerhaubitze-72.html",kicker:"Long-range successor",label:"Panzerhaubitze 72"},{href:"german-postwar-artillery.html",kicker:"System overview",label:"German Postwar Artillery"},{href:"german-flakpanzer-lineage.html",kicker:"Parallel tracked system",label:"German Flakpanzer Lineage"},{href:"jaeger-arm-germany.html",kicker:"Operational limit",label:"Jäger Arm"}],
  ...
  "german-flakpanzer-lineage": germanWeaponArticle({
    ...
    landscape:fireSupportLandscape,
    lead:"Germany's registered postwar Flakpanzer sequence comprised the Flakpanzer IX Kugelblitz II, Flakpanzer X Habicht, and Flakpanzer XI. The line moved from twin 30 mm cannon and optical control to twin 35 mm cannon with separate search and tracking radars.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-c2w6l writer=g kind=revision created=2026-08-15T19:30:00-06:00 -->The three designations, introduction dates, cannon calibers, Kugelblitz II ammunition load and later range radar, Habicht search and range-only tracking radars, and Flakpanzer XI separate search and tracking radars are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Chassis identities, vehicle mass, crew, engines, radar models and bands, engagement envelopes, production totals, and service variants remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
      {id:"kugelblitz",title:"Flakpanzer IX Kugelblitz II",html:"<p>The <a href='flakpanzer-ix-kugelblitz-ii.html'>Kugelblitz II</a> entered service in 1952 with twin 30×184B mm cannon and 800 rounds carried. It used an enclosed optical air-defense system. Later equipment added range radar, but the date and scope of that modification remain open.</p>"},
      {id:"habicht",title:"Flakpanzer X Habicht",html:"<p>The <a href='flakpanzer-x-habicht.html'>Habicht</a> entered service in 1962 with twin 35×228 mm cannon. It combined search radar with range-only tracking radar for all-weather divisional air defense.</p><p>The registry does not define radar band, aerial arrangement, tracking in azimuth or elevation, fire-control computer, or ammunition load.</p>"},
      {id:"xi",title:"Flakpanzer XI",html:"<p>The <a href='flakpanzer-xi.html'>Flakpanzer XI</a> entered service in 1975. It retained twin 35×228 mm cannon and used separate search and tracking radars. It formed the third registered postwar gun-air-defense generation.</p>"},
    ...
    related:[{href:"flakpanzer-ix-kugelblitz-ii.html",kicker:"1952 generation",label:"Flakpanzer IX Kugelblitz II"},{href:"flakpanzer-x-habicht.html",kicker:"1962 generation",label:"Flakpanzer X Habicht"},{href:"flakpanzer-xi.html",kicker:"1975 generation",label:"Flakpanzer XI"},{href:"german-postwar-artillery.html",kicker:"Divisional fire support",label:"German Postwar Artillery"},{href:"panzerhaubitze-family.html",kicker:"Tracked artillery",label:"Panzerhaubitze 55 and 72"}],
