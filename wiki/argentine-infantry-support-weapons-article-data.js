...
Object.assign(window.deepArticles, {
  "argentine-infantry-support-weapons": argentineWeaponArticle({
    ...
    sections:[
      ...
      {id:"falklands",title:"Falklands War",html:"<p>Argentine infantry antitank teams and artillery join the <a href='argentine-armored-systems.html'>armored force</a> in the prepared defense of East Falkland. At <a href='battle-mount-pleasant-1985.html'>Mount Pleasant</a>, their function is part of a combined system of vehicles, infantry, pre-registered fire, night equipment, workshops, and local supply rather than a collection of isolated imports.</p><p>Exact weapon totals, unit allocations, engagements, expenditure, and losses remain open.</p>"}
    ],
    ...
    facts:[["Country","Argentina"],["Coverage","1967–1985"],["Registered named systems","Five"],["Complete-weapon source","Greater German Reich"],["Local production","Compatible ammunition and ordinary support materiel"],["Documentation","Spanish-language service system"],["Principal combat context","Falklands War"]]
  }),
  ...
  "faa-67": argentineWeaponArticle({
    ...
    infoboxTitle:"FAA-67",
    lead:"The Fusil Automático Argentino Modelo 67, abbreviated FAA-67, is Argentina's service designation for an imported tropicalized German StG 60. Introduced in 1967, it fires the 5.6×40 mm cartridge manufactured compatibly in Argentina under license.",
    canon:"The full name, FAA-67 abbreviation, 1967 introduction, 5.6×40 mm cartridge, imported German-built and tropicalized StG 60 identity, and licensed Argentine ammunition production are established. Tropicalization measures, manufacturer, procurement total, local furniture or finish, sights, unit issue, variants, wartime performance, and retirement remain open.",
    sections:[
  ...
  "aa-68": argentineWeaponArticle({
    ...
    infoboxTitle:"AA-68",
    lead:"The Ametralladora Argentina Modelo 68, abbreviated AA-68, is Argentina's service designation for the imported German MG 68 general-purpose machine gun. It enters Argentine service in 1968 and fires 7.92×57 mm ammunition from a disintegrating belt.",
    canon:"The full name, AA-68 abbreviation, 1968 introduction, 7.92×57 mm cartridge, disintegrating-belt feed inherited from the registered parent system, general-purpose role, imported German identity, and Argentine service designation are established. Exact mass, action, barrel system, rate of fire, mounts, local modifications, manufacturer, procurement total, unit issue, and postwar service remain open.",
    sections:[
  ...
  "dragon-modelo-70": argentineWeaponArticle({
    ...
    lead:"Dragón Modelo 70 is Argentina's service designation for the imported German Drachen wire-guided antitank missile. Introduced in 1970, its registered parent system uses a 135 mm missile with a 3,000 m effective range and 600 mm RHA penetration.",
    canon:"The Dragón Modelo 70 designation, 1970 Argentine introduction, imported German Drachen identity, 135 mm caliber, wire guidance, 3,000 m parent-system effective range, 600 mm RHA parent-system penetration, and infantry antitank role are established. Argentine launcher configuration, crew, missile block, vehicle mounts, local modifications, procurement total, unit issue, wartime expenditure, and postwar service remain open.",
    sections:[
      ...
      {id:"falklands",title:"Falklands War",html:"<p>Dragón teams form part of Argentine planning against British armor and protected movement in the South Atlantic campaign. Individual engagements, firing positions, missile expenditure, hit rates, and losses remain unregistered.</p>"},
    ...
    facts:[["Operator","Argentina"],["Introduction","1970"],["Caliber","135 mm"],["Guidance","Wire-guided"],["Effective range","3,000 m parent baseline"],["Penetration","600 mm RHA parent baseline"],["Parent system","Drachen 66"],["Procurement","Imported complete system"]]
  }),
  ...
  "panzerfaust-74a": argentineWeaponArticle({
    ...
    lead:"Panzerfaust 74A is Argentina's imported form of the German Panzerfaust 74 disposable antitank weapon. Entering Argentine service in 1976, it uses the parent system's 110 mm HEAT projectile for short-range infantry defense.",
    canon:"The Panzerfaust 74A designation, 1976 Argentine introduction, imported German identity, disposable construction, 110 mm HEAT projectile, short-range infantry role, and complementary service with Dragón Modelo 70 are established. Whether the A suffix marks a physical export modification, exact performance of the Argentine delivery, sights, launcher dimensions and mass, manufacturer, procurement total, unit issue, wartime expenditure, and postwar service remain open.",
    sections:[
  ...
  "obus-autopropulsado-modelo-72": argentineWeaponArticle({
    ...
    lead:"The Obús Autopropulsado Modelo 72 is Argentina's imported 149.1 mm L/45 self-propelled howitzer introduced in 1978. It is derived from the German Panzerhaubitze system, while Argentina manufactures compatible ammunition under license.",
    canon:"The full designation, 1978 introduction, imported complete-vehicle status, German Panzerhaubitze-derived relationship, 149.1 mm L/45 howitzer, self-propelled artillery role, and licensed Argentine compatible-ammunition production are established. Exact relationship to the Panzerhaubitze 72, chassis, mass, crew, engine, armor, range, loading system, fire-direction equipment, ammunition stowage, manufacturer, procurement total, units, variants, wartime employment, and postwar service remain open.",
    sections:[
      ...
      {id:"falklands",title:"Falklands War",html:"<p>Argentine artillery supports prepared positions and armored forces in the Falklands campaign. The source does not fix how many Modelo 72 vehicles deploy, their batteries, firing sites, expenditure, losses, or individual actions.</p>"},
    ...
    facts:[["Operator","Argentina"],["Introduction","1978"],["Type","Self-propelled howitzer"],["Caliber","149.1 mm L/45"],["Relationship","German Panzerhaubitze-derived"],["Procurement","Imported complete vehicle"],["Argentine production","Compatible ammunition under license"],["Exact parent configuration","Open"]]
  })
});
