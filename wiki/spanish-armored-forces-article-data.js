...
Object.assign(window.deepArticles, {
  "spanish-armored-forces": spanishArmorArticle({
    ...
    lead:"Spain's armored forces combine Italian Ariete-series main battle tanks, Occitan light armor, and <a href='spanish-wheeled-armored-vehicles.html'>Spanish-built wheeled carriers and reconnaissance vehicles</a>. The result is a mixed procurement system: allied tank lineages provide the principal tracked combat vehicles while domestic industry concentrates on road-mobile troop lift, reconnaissance, ammunition, artillery, and support production.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-a4n8q writer=g kind=revision created=2026-08-15T19:55:00-06:00 -->The principal use of Italian Ariete-series main battle tanks, Occitan light armor, and Spanish-built wheeled carriers and reconnaissance vehicles is established. Spain also develops artillery, ammunition, and licensed Italian and Occitan armor.<sup class='canon-note' data-provenance='a'>[a]</sup> Individual Spanish service designations, exact Ariete or Occitan variants, procurement dates, license arrangements by model, quantities, formations, wheeled-vehicle names, specifications, and complete operational history remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "spanish-wheeled-armored-vehicles": spanishArmorArticle({
    ...
    lead:"Spanish wheeled armored vehicles are the domestically built carrier and reconnaissance branch of the <a href='spanish-armored-forces.html'>Spanish armored forces</a>. They give Spain a national road-mobile specialty beside Italian Ariete-series main battle tanks and Occitan light armor, and provide the vehicle type most clearly associated with Spain's ground contribution in Portuguese Angola.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-b6p2s writer=g kind=revision created=2026-08-15T19:55:00-06:00 -->Spanish construction of wheeled carriers and reconnaissance vehicles is established, as are the Spanish use of armored cars, trucks, engineers, and motorized troops in Portuguese Angola.<sup class='canon-note' data-provenance='a'>[a]</sup> Vehicle names, manufacturers, wheel arrangements, dates, weights, crews, armor, weapons, engines, range, amphibious capability, production totals, unit structures, variants, and exports remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
