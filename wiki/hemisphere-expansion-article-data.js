...
Object.assign(window.deepArticles, {
  ...
  "uruguay": hemisphereArticle({
    ...
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260816-c3d7j writer=g kind=revision created=2026-08-16T04:00:00-06:00 -->The transition from military rule to a neutral civilian clearing center and Uruguay's mediating role, including the fixed 1986 Punta del Este peace, are established at framework level.<sup class='canon-note' data-provenance='a'>[a]</sup> Exact restoration dates, leaders, pact, and constitutional sequence remain working history.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "paraguay": hemisphereArticle({
    ...
    lead:"<!-- altwwii-writer-block:start id=wb-g-20260816-d8e4l writer=g kind=revision created=2026-08-16T04:00:00-06:00 -->Paraguay is an authoritarian inland balancer whose government turns geography into leverage. Alfredo Stroessner's historical regime is the developed working route, not a fixed ruler sequence. Asunción serves as buffer, marketplace, intelligence crossroads, and transit negotiator among Argentina, Brazil, Bolivia, the United States, Germany, and the Latin powers.<sup class='canon-note' data-provenance='a'>[a]</sup><sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260816-e5f9m writer=g kind=revision created=2026-08-16T04:00:00-06:00 -->Paraguay's authoritarian buffer-market role is established at the strategic level.<sup class='canon-note' data-provenance='a'>[a]</sup> Stroessner's continued rule, detailed treaties, institutional implementation, later succession, and the scale of each foreign network remain working history under P2-12.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
    ...
    facts:[["Capital","Asunción"],["Working head of state","Alfredo Stroessner"],["Government","Authoritarian republic"],["1985 alignment","Neutral / Independent"],["Strategic role","Inland buffer and marketplace"],["Principal transport","Paraguay–Paraná river system"],["External balance","Argentina, Brazil, United States"],["Exact ruler and succession","Open"]]
  }),
  ...
  "panama": hemisphereArticle({
    ...
    sections:[
      ...
      {id:"1968",title:"The 1968 rupture",html:"<p>Military intervention displaces the prior party order and creates a <a href='panamanian-military-regime.html'>nationalist security regime</a>. The government seeks greater Panamanian dignity without convincing Washington that strategic control can safely be transferred.</p>"},
  ...
  "nicaragua": hemisphereArticle({
    ...
    lead:"Nicaragua is an American-aligned Central American republic contested by a broad, ideologically divided Sandinista movement without a surviving Soviet patron. The conflict is nationalist, anti-dynastic, agrarian, and socially revolutionary, while Cuban, Catholic, and Hispanic networks compete with American security power over its political outcome.",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-q9y5n writer=g kind=revision created=2026-08-15T23:50:00-06:00 -->American alignment, the late-1970s collapse of the Somoza dynasty, a broad and ideologically divided Sandinista conflict, Cuban and Latin support for anti-American factions, Honduran support for the American-backed side, and an uneasy settlement around 1980–82 are established.<sup class='canon-note' data-provenance='a'>[a]</sup> Managua Settlement is the working name for one developed package. Exact leaders, war dates, faction names, settlement title, institutions, constitutional provisions, and demobilization totals remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
      {id:"order",title:"The established order",html:"<p>A family-centered security regime, landholding interests, the National Guard, and American support dominated the postwar state until the dynasty's late-1970s collapse. Its anticommunism retained value after Soviet collapse because Washington feared any rival foothold near the canal approaches.</p>"},
      {id:"sandinistas",title:"The Sandinista movement",html:"<p>Sandinismo draws on national sovereignty, anti-dynastic memory, agrarian reform, student politics, Catholic social action, Marxist organizing, and resistance to American control. Without a Soviet center, no externally disciplined Marxist party monopolizes the movement. Cuba supplies direct aid to armed anti-American factions.</p>"},
      ...
      {id:"foreign",title:"Competing foreign influence",html:"<p>Washington supplies security assistance and political limits. Cuba assists armed anti-American factions. Spain and Latin Catholic networks possess cultural access; Germany and Japan can offer selective equipment or commerce but cannot safely establish combat missions.</p>"},
      {id:"war",title:"The unsettled conflict",html:"<p>Insurgency, repression, negotiation, and factional fracture define the working chronology. The absence of Soviet sponsorship changes outside aid without removing the causes of rebellion.</p>"},
      ...
      {id:"open",title:"Working Managua settlement",html:"<!-- altwwii-writer-block:start id=wb-g-20260815-r2z6p writer=g kind=revision created=2026-08-15T23:50:00-06:00 --><p>An uneasy settlement around 1980–82 is fixed at framework level. The <a href='managua-settlement.html'>Managua Settlement</a> name and its coalition government, reorganized constabulary, fighter integration, local elections, American access, guarantees, and exclusion zones are a developed working implementation. Exact institutions, provisions, officeholders, and dates remain open.<sup class='canon-note' data-provenance='e'>[e]</sup></p><!-- altwwii-writer-block:end -->"}
    ],
    ...
    facts:[["Capital","Managua"],["Government","Postwar form open; coalition republic is working"],["1985 alignment","American Hemisphere"],["Principal armed challenge","Broad, divided Sandinista movement"],["Soviet patronage","Absent"],["Cuban role","Support for anti-American factions"],["External competitors","United States, Cuba, and Latin networks"],["Settlement","c. 1980–82; exact name and provisions open"]]
  }),
  ...
  "mexican-catholic-national-settlement": hemisphereArticle({
    ...
    sections:[
      ...
      {id:"legal-order",title:"Constitutional and ecclesiastical authority",html:"<!-- altwwii-writer-block:start id=wb-c-20260816-k6m2v writer=c kind=analysis created=2026-08-16T13:42:56-06:00 --><p>The mediated settlement and the constitutional acts implementing it established Mexican civil rights and institutions. Repeal of anticlerical provisions, restoration of legal personality, school freedom, public worship, property protection, chaplaincies, or civil recognition of marriage required Mexican law. The arrangement was not a concordat unless the Holy See was actually a party to a diplomatic agreement. Participation by bishops or Vatican mediators did not turn the entire political compromise into an act of Church government.</p><p>Civil recognition of the Church also required identification of the legal holder. A diocese, parish, religious institute, school corporation, charity, lay association, cooperative, or foundation could possess different civil and canonical status. Registration or title protected an institution in Mexican law. It did not erect a diocese or parish, appoint a bishop, create a religious institute, determine doctrine, or make the cabinet the source of ecclesiastical jurisdiction. Exact implementing statutes and any bilateral Holy See instruments remain open.</p><p>A Catholic public order could recognize holidays, education, marriage, chaplaincies, and public devotion while leaving Protestants, Jews, secular citizens, and other communities able to hold property, organize, seek judgment, and decline Catholic worship. Constitutional texts, implementing statutes, corporate registrations, deeds, school licenses, appointment correspondence, diplomatic notes, court cases, and complaints are needed to measure the settlement. Institutional expansion could reflect restored freedom, political privilege, state subsidy, or unequal local enforcement.</p><!-- altwwii-writer-block:end -->"},
