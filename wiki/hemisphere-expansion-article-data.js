...
Object.assign(window.deepArticles, {
  ...
  "panama": hemisphereArticle({
    ...
    related:[{href:"colombia.html",kicker:"Southern neighbor",label:"Colombia"},{href:"hemispheric-renewal-act.html",kicker:"American regional doctrine",label:"Hemispheric Renewal Act"}],
  ...
  "nicaragua": hemisphereArticle({
    ...
    related:[{href:"honduras.html",kicker:"Northern American client",label:"Honduras"},{href:"panama.html",kicker:"Southern strategic system",label:"Panama"},{href:"catholicism-in-latin-bloc.html",kicker:"Catholic diplomatic network",label:"Catholicism in the Latin Bloc"}],
...
],{id:"secondary-states",title:"Secondary states and active neutrality",html:"<p>The dedicated histories of <a href='ecuador.html'>Ecuador</a>, <a href='uruguay.html'>Uruguay</a>, <a href='paraguay.html'>Paraguay</a>, <a href='bolivia.html'>Bolivia</a>, <a href='panama.html'>Panama</a>, <a href='nicaragua.html'>Nicaragua</a>, and <a href='suriname.html'>Suriname</a> show that the chart's smaller entries are not empty spaces. Ports, minerals, routes, religious networks, canal defenses, and diplomatic venues let them shape the competition around them.</p>"});
