...
Object.assign(window.deepArticles, {
  "imperial-japanese-navy-postwar": japaneseNavalArticle({
    ...
    canon:"The revised 1947 capital, fleet/light-carrier, and submarine inheritance; carrier-first doctrine; eight first-line fleet carriers and four Zuihō II light carriers; four modern carrier-guard battleships; three Yamato-class reserve, support, training, or experimental hulls; Type 42 Tsubaki role; and imperial-base integration are established. Exact 1985 cruiser, escort, submarine, amphibious, mine, and auxiliary totals remain open.",
    sections:[
  ...
  "japanese-carrier-system": japaneseNavalArticle({
    ...
    canon:"The integrated system, eight first-line fleet carriers in four divisions, class composition of two Hiryū II, four Taihō II, and two Hakuryū ships, four Zuihō II light carriers, carrier-first doctrine, supporting components, and Type 42 Tsubaki relationship are established. Individual ship names within incompletely registered classes, air-wing totals and aircraft types, sortie rates, command procedures, and deployment patterns remain open.",
    sections:[
    ...
    related:[{href:"japanese-wartime-carrier-inheritance.html",kicker:"First generation",label:"Wartime Carrier Inheritance"},{href:"hakuryu-class-carrier.html",kicker:"Latest generation",label:"Hakuryū Class"},{href:"zuiho-ii-class.html",kicker:"Light-carrier arm",label:"Zuihō II Class"},{href:"japanese-surface-escorts.html",kicker:"Protective screen",label:"Japanese Surface Escorts"}],
  ...
  "yamato-class-postwar": japaneseNavalArticle({
    ...
    sections:[
      ...
      {id:"modernization",title:"Postwar reconstruction",html:"<p>Shinano underwent a circa 1970–74 reconstruction as a nuclear battleship and electrical testbed. Exact 1985 propulsion, armament, electronics, and refit configuration for all three hulls remain open.</p>"},
      {id:"doctrine",title:"Relationship to carrier doctrine",html:"<p>Official doctrine held that carriers created the battle. Four modern fast battleships, not the three Yamato-class hulls, guarded first-line carrier formations in 1985.</p>"},
  ...
  "japanese-wartime-carrier-inheritance": japaneseNavalArticle({
    ...
    canon:"Continuity from the wartime carrier establishment into the Hiryū II, Taihō II, and Hakuryū generations, Taihō's survival, and Shinano's completion as a battleship are established. The complete wartime carrier roster, exact specifications, air groups by year, damage and reconstruction details, and individual service histories remain open.",
    sections:[
