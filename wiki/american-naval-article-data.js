...
Object.assign(window.deepArticles, {
  "us-navy-postwar": americanNavalArticle({
    ...
    sections:[
      {id:"inheritance",title:"Neutral-war inheritance",html:"<p>The United States did not enter the general war and suffered no naval combat attrition. On 31 December 1947 it possessed twenty-five capital ships, thirteen carriers, forty-seven cruisers, 145 destroyers, sixty major escorts, and 125 submarines afloat.</p><p>The fleet remained below contemporary projections for full belligerent mobilization because the emergency mass carrier, destroyer, and merchant programs never reached the same scale.</p>"},
  ...
  "american-neutral-war-fleet": americanNavalArticle({
    ...
    sections:[
      ...
      {id:"battleships",title:"Battleship program",html:"<p>The twenty-five battleships comprised fifteen older standard and pre-standard ships, two <em>North Carolina</em>-class ships, four <em>South Dakota</em>-class ships, and four <em>Iowa</em>-class ships. <em>Montana</em> and <em>Ohio</em> remained under construction and commissioned in 1948 and 1950.</p><p>Twenty of the twenty-five ships were operational at the reference date.</p>"},
      {id:"carriers-cruisers",title:"Carriers and cruisers",html:"<p>America completed thirteen fleet carriers by 1947, of which eleven were operational. Forty of forty-seven cruisers were operational. The carrier total reflected limited mobilization rather than the production required by continuous Pacific combat.</p>"},
      {id:"destroyers",title:"Destroyers and major escorts",html:"<p>The Navy held 145 destroyers and sixty major escorts afloat; 105 destroyers and forty escorts were operational. Seventy-two new destroyers were built for American or export use.</p>"},
      {id:"transfers",title:"Foreign transfers",html:"<p>Fifty older destroyers and thirty-six modern ships passed to Britain or Commonwealth customers. Transfers supported British convoy protection and route defense while reducing the American reserve burden.</p>"},
      {id:"submarines",title:"Submarine force",html:"<p>Ninety-five of 125 submarines were operational. The remaining thirty boats included repair, training, reserve, obsolete, and disposition categories. The absence of American combat patrols preserved hulls but limited current operational experience.</p>"},
      {id:"merchant",title:"Merchant construction",html:"<p>The emergency merchant program produced 720 EC2 or Liberty-type ships, 180 faster Victory-type ships, and 250 tankers or specialized cargo hulls. The program was large but remained below a full belligerent mobilization.</p>"},
      {id:"registry",title:"Registry reconstruction",html:"<p>Aggregate totals and the battleship composition are fixed. Most individual cruiser, destroyer, escort, and submarine records use class allocations where continuous service records are absent. Extrapolated hulls are marked in the registry.</p>"},
    ...
    facts:[["Reference date","31 December 1947"],["Capital ships afloat / operational","25 / 20"],["Fleet carriers afloat / operational","13 / 11"],["Cruisers afloat / operational","47 / 40"],["Destroyers afloat / operational","145 / 105"],["Major escorts afloat / operational","60 / 40"],["Submarines afloat / operational","125 / 95"],["New destroyer program","72 ships"],["Older destroyers transferred","50"],["Modern ships transferred","36"]]
  }),
