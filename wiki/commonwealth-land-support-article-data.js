...
Object.assign(window.deepArticles, {
  "commonwealth-wheeled-armour": commonwealthLandArticle(commonwealthWheeledLandscape, {
    ...
    lead:"Commonwealth wheeled armour in 1985 centers on South Africa's <a href='ratel-20.html'>Ratel 20</a> mechanized carrier and <a href='ratel-90.html'>Ratel 90</a> fire-support vehicle. The pair provides economical road and convoy mobility across the African and Atlantic system, but its poor performance in deep peat, marsh, and broken trackless slopes strictly limits employment in the Falklands.",
    canon:"The two registered vehicles, introduction dates, weights, crews and troop capacities, armaments, roles, common road and firm-ground strengths, soft-ground limits, post–Mount Pleasant Falklands employment boundary, and theater totals are fixed. Dimensions, engines, speeds, ranges, armor, ammunition, production, units, losses, and post-1985 development remain open.",
    sections:[
  ...
  "ratel-20": commonwealthLandArticle(commonwealthWheeledLandscape, {
    ...
    lead:"Ratel 20 is a South African wheeled mechanized carrier introduced in 1976. The 18.5-tonne vehicle carries a crew of three, seven infantry, and a 20×139 mm cannon, giving Commonwealth road columns protected infantry lift and cannon support.",
    canon:"The name, 1976 introduction, 18.5-tonne weight, three-person crew plus seven troops, 20×139 mm cannon, mechanized-carrier role, mobility envelope, post–Mount Pleasant employment, and Falklands total of six are fixed. Automotive details, armor, dimensions, ammunition, production, units, and losses remain open.",
    sections:[
  ...
  "ratel-90": commonwealthLandArticle(commonwealthWheeledLandscape, {
    ...
    lead:"Ratel 90 is a South African road-mobile fire-support vehicle introduced in 1978. It places a 90 mm low-recoil gun, four-person crew, and six troops on the Ratel wheeled platform, providing direct fire along the engineered routes of the Commonwealth system.",
    canon:"The name, 1978 introduction, 19.0-tonne weight, four-person crew plus six troops, 90 mm low-recoil gun, road-mobile fire-support role, mobility envelope, post–Mount Pleasant employment, and Falklands total of three are fixed. Automotive details, armor, gun performance, ammunition, production, units, and losses remain open.",
    sections:[
  ...
  "british-artillery": commonwealthLandArticle(britishArtilleryLandscape, {
    ...
    lead:"British field artillery in 1985 divides four missions among the light tracked <a href='fv433-abbot.html'>FV433 Abbot</a>, medium tracked <a href='fv436-bishop-ii.html'>FV436 Bishop II</a>, air-portable <a href='l118-light-gun.html'>L118 Light Gun</a>, and South African-led <a href='commonwealth-l45.html'>Commonwealth L45</a>. The system favors deployable complementary weapons rather than one universal gun.",
    canon:"The four systems, introduction dates, calibers, barrel lengths, weights, standard ranges, roles, Bishop II and later-program boundaries, Kuwait employment of Abbot and L118, and Falklands totals of 12 Abbots and six Bishop IIs are fixed. Crews, ammunition, rates of fire, mobility details, production, units, losses, and post-1985 programs remain open.",
    sections:[
  ...
  "fv433-abbot": commonwealthLandArticle(britishArtilleryLandscape, {
    ...
    lead:"FV433 Abbot is Britain's light tracked divisional-artillery system introduced in 1965. Its 105 mm L13 L/35 has a registered standard range of 17.4 km, while the 16.6-tonne tracked platform allows it to accompany armored formations in Kuwait and the Falklands.",
    canon:"The name, 1965 introduction, 105 mm L13 L/35, 16.6-tonne weight, 17.4 km standard range, light tracked divisional role, Kuwait presence, and Falklands total of 12 are fixed. Crew, chassis details, ammunition, rate of fire, armor, engine, speed, production, units, and losses remain open.",
    sections:[
  ...
  "fv436-bishop-ii": commonwealthLandArticle(britishArtilleryLandscape, {
    ...
    lead:"FV436 Bishop II is Britain's medium tracked divisional-artillery system introduced in 1977. The 32-tonne vehicle carries a 155 mm L39 with a registered standard range of 24.7 km and supplies the heavier tracked artillery layer beside FV433 Abbot.",
    canon:"The name, 1977 introduction, 155 mm L39, 32.0-tonne weight, 24.7 km standard range, medium tracked divisional role, replacement of premature AS-90 references, and Falklands total of six are fixed. Crew, chassis, ammunition, rate of fire, fire control, armor, engine, production, units, and losses remain open.",
    sections:[
  ...
  "l118-light-gun": commonwealthLandArticle(britishArtilleryLandscape, {
    ...
    lead:"The L118 Light Gun is Britain's air-portable and amphibious 105 mm artillery system, introduced in 1974. At 1.9 tonnes, its 105 mm L19 reaches a registered 17.2 km and gives airborne, marine, and expeditionary forces artillery that can travel where tracked vehicles cannot.",
    canon:"The name, 1974 introduction, 105 mm L19, 1.9-tonne weight, 17.2 km standard range, air-portable and amphibious role, and Kuwait service are fixed. Crew, ammunition, rate of fire, towing arrangements, airlift method, production, units, Falklands total, losses, and variants remain open.",
    sections:[
  ...
  "commonwealth-l45": commonwealthLandArticle(britishArtilleryLandscape, {
    ...
    lead:"Commonwealth L45 is a South African-led 155 mm long-range towed gun introduced in 1979. The 13.8-tonne L45 system has a registered standard range of 30.0 km, the longest of the four British and Commonwealth artillery systems recorded for 1985.",
    canon:"The designation, 1979 introduction, South African-led development, 155 mm L45 armament, 13.8-tonne weight, 30.0 km standard range, long-range towed role, and exclusion of a wheeled G6-class system from 1985 service are fixed. Partners, crew, ammunition, rate of fire, carriage, towing vehicles, production, units, campaigns, and variants remain open.",
    sections:[
