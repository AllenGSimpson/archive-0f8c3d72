...
Object.assign(window.deepArticles, {
  "latin-land-ammunition-standards": italianInfantryArticle({
    ...
    lead:"The Latin bloc standardizes selected cartridges and interfaces while preserving national weapons industries. The 7×51 mm LC becomes the common full-power rifle and machine-gun cartridge in 1958, 5.6×45 mm LC the common small-caliber assault-rifle cartridge in 1968, 25×137 mm and 30×170 mm the principal light-vehicle cannon rounds, 105×617R mm the shared 1960s tank cartridge, and 120×560R mm LC the new tank cartridge of the 1980s.",
    canon:"The selective-standardization principle, six named ammunition or interface standards, roles, adoption eras, Italian 7.35×51 mm and Spanish 7×57 mm reserve retention, and Guida Comune 79's independence from Picatinny are fixed. Projectile construction, case material, pressure, velocity, chamber tolerances, proof rules, manufacturers, packaging, interchange limits, national loadings, stockpile quantities, conversion schedules, and interface dimensions remain open.",
    sections:[
  ...
  "italian-infantry-weapons": italianInfantryArticle({
    ...
    lead:"Italian infantry weapons move from the national 7.35×51 mm Fucile Modello 47 through the common Latin 7×51 mm battle-rifle and machine-gun system to 5.6×45 mm assault rifles. The Fucile Automatico 58 and Mitragliatrice 59 establish full-power standardization; the Beretta AR-68 becomes the ordinary small-caliber assault rifle; and the modular Beretta AR-82 adds the Guida Comune 79 accessory interface.",
    canon:"The five registry weapons, names, introduction dates, cartridges, feeds, standard roles, AR-82 modular character, AR-82 use of Guida Comune 79, and Latin standardization context are fixed. Operating mechanisms, dimensions, masses, barrel lengths, rates of fire, sights, controls, furniture, bayonets, grenade capability, manufacturers beyond the Beretta names, production totals, variants, issue scales, units, exports, and combat histories remain open.",
    sections:[
  ...
  "fucile-modello-47": italianInfantryArticle({
    ...
    lead:"The Fucile Modello 47 is Italy's semiautomatic victory-year service rifle. Introduced in 1947, it uses the national 7.35×51 mm cartridge and a ten-round magazine, bridging wartime Italian ammunition practice to the later Latin-standard Fucile Automatico 58.",
    canon:"The formal name, 1947 introduction, 7.35×51 mm cartridge, ten-round magazine, semiautomatic operation, service-rifle role, and later reserve-cartridge context are fixed. Manufacturer, mechanism, dimensions, mass, barrel length, sights, magazine details, loading method, bayonet, accessories, production total, variants, units, exports, combat history, and retirement remain open.",
    sections:[
  ...
  "fucile-automatico-58": italianInfantryArticle({
    ...
    lead:"The Fucile Automatico 58 is Italy's selective-fire full-power battle rifle of 1958. Its twenty-round magazine and 7×51 mm LC cartridge place the Italian infantry rifle inside the first common Latin small-arms standard.",
    canon:"The formal name, 1958 introduction, 7×51 mm LC cartridge, twenty-round magazine, selective-fire operation, and battle-rifle role are fixed. Manufacturer, mechanism, dimensions, mass, barrel length, rate of fire, sights, controls, magazine interchangeability, bayonet, grenade capability, accessories, production total, variants, units, exports, combat history, and retirement remain open.",
    sections:[
  ...
  "mitragliatrice-59": italianInfantryArticle({
    ...
    lead:"The Mitragliatrice 59 is Italy's Latin-standard general-purpose machine gun of 1959. It uses the common 7×51 mm LC full-power cartridge and a disintegrating belt, providing sustained infantry and mounted fire alongside the magazine-fed Fucile Automatico 58.",
    canon:"The formal name, 1959 introduction, 7×51 mm LC cartridge, disintegrating-belt feed, and Latin-standard general-purpose-machine-gun role are fixed. Manufacturer, mechanism, dimensions, mass, barrel system, cyclic rate, belt capacity, mountings, sights, secondary configurations, production total, variants, units, exports, combat history, and retirement remain open.",
    sections:[
  ...
  "beretta-ar-68": italianInfantryArticle({
    ...
    lead:"The Beretta AR-68 is Italy's standard 5.6×45 mm LC assault rifle of 1968. Fed from a thirty-round magazine, it introduces the Latin small-caliber cartridge to ordinary Italian rifle service while full-power 7 mm weapons remain in machine-gun, reserve, and overlapping roles.",
    canon:"The Beretta AR-68 name, Beretta association, 1968 introduction, 5.6×45 mm LC cartridge, thirty-round magazine, and standard-assault-rifle role are fixed. Mechanism, dimensions, mass, barrel length, rate of fire, fire-control modes, sights, furniture, magazine compatibility, bayonet, grenade capability, accessories, production total, variants, units, exports, combat history, and retirement remain open.",
    sections:[
  ...
  "beretta-ar-82": italianInfantryArticle({
    ...
    lead:"The Beretta AR-82 is Italy's modular late-generation assault rifle of 1982. It retains the 5.6×45 mm LC cartridge and thirty-round magazine of the AR-68 while adding the Guida Comune 79 optical and accessory mounting bar.",
    canon:"The Beretta AR-82 name, Beretta association, 1982 introduction, 5.6×45 mm LC cartridge, thirty-round magazine, modular late-generation role, and use of Guida Comune 79 are fixed. Mechanism, dimensions, mass, barrel lengths, rate of fire, fire-control modes, modular components, sights, furniture, magazine compatibility, bayonet, grenade capability, accessories, production total, variants, units, exports, and combat history remain open.",
    sections:[
  ...
  "guida-comune-79": italianInfantryArticle({
    ...
    eyebrow:"Latin optical and accessory interface · 1979 standard",
    infoboxKicker:"Common mounting bar",
    infoboxTitle:"Guida Comune 79",
    lead:"Guida Comune 79 is the Latin bloc's common optical and accessory mounting bar. Adopted as a 1979 standard and used on the Beretta AR-82, it gives national weapons and accessories a shared attachment policy without copying the later Picatinny rail.",
    canon:"The Guida Comune 79 name, Latin common-standard status, optical and accessory mounting function, association with Beretta AR-82, and independence from Picatinny are fixed. The precise adoption instrument, dimensions, cross-section, slots, clamps, recoil stops, materials, mounting positions, sight families, environmental tests, certification authority, and compatibility with other blocs' interfaces remain open.",
    sections:[
      ...
      {id:"adoption",title:"1979 standard",html:"<p>The 79 designation places the common standard in 1979. The controlling registry does not identify the treaty, board, arsenal, or technical commission that issued it.</p>"},
    ...
    facts:[["Alignment","Latin Bloc"],["Standard","Guida Comune 79"],["Adoption year","1979"],["Function","Optical and accessory mounting bar"],["Fixed host weapon","Beretta AR-82"],["Picatinny compatibility","None established"],["Dimensions","Open"],["Certification authority","Open"]]
  })
});
