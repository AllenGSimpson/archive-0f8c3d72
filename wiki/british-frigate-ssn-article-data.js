...
Object.assign(window.deepArticles, {
  "british-frigate-force": britishNavalArticle({
    ...
    lead:"The British postwar frigate force was the specialized anti-submarine screen of the Siege Commonwealth. Forty-eight Rothesay-, Leander-, and Broadsword-class frigates were active in 1985. The preceding Whitby class had established the quiet postwar escort line but had left front-line service.",
    canon:"Whitby, Rothesay, Leander, and Broadsword totals, dates, displacements, propulsion, individual rosters, roles, 1985 active balance, helicopter, variable-depth-sonar, and towed-array progression, and force-wide ASW specialization are established. Detailed sonar models, weapons, helicopter types, machinery arrangements, crews, formations, readiness, deployments, and most individual histories remain open.",
    sections:[
  ...
  "whitby-class-frigate": britishNavalArticle({
    ...
    lead:"The Whitby class was a sixteen-ship British anti-submarine frigate class introduced between 1954 and 1959. The 2,800-tonne steam-turbine ships formed Britain's quiet first-generation postwar ASW escort line. All had decommissioned by 1980.",
    canon:"The sixteen-ship roster, individual commissioning and decommissioning years, 2,800-tonne full-load displacement, steam-turbine propulsion, quiet first-generation postwar ASW role, and zero active 1985 total are established. Dimensions, speed, weapons, sensors, crew, builders, deployments, refits, and final dispositions remain open.",
    sections:[
  ...
  "rothesay-class-frigate": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Rothesay class was a twenty-ship British anti-submarine frigate class introduced between 1958 and 1965. The 3,000-tonne steam-turbine ships combined helicopter ASW with variable-depth sonar. Ten remained active in 1985.",
    canon:"The twenty-ship roster, individual commissioning and decommissioning years, 3,000-tonne full-load displacement, steam-turbine propulsion, helicopter ASW and variable-depth-sonar roles, ten active and ten decommissioned ships, and 1985 status are established. Dimensions, speed, weapons, sonar model, helicopter type, crew, builders, deployments, refits, and final dispositions remain open.",
    sections:[
  ...
  "leander-class-frigate": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The postwar Leander class was a twenty-six-ship British frigate class introduced between 1962 and 1973. The 3,600-tonne steam-turbine ships served as general escorts with strong anti-submarine specialization. Twenty remained active in 1985.",
    canon:"The twenty-six postwar-frigate roster, individual commissioning and decommissioning years, 3,600-tonne full-load displacement, steam-turbine propulsion, general-escort and ASW roles, twenty active and six decommissioned ships, and 1985 status are established. The class is distinct from the surviving prewar Leander-class cruisers. Dimensions, speed, weapons, sensors, helicopters, crew, builders, deployments, refits, and final dispositions remain open.",
    sections:[
  ...
  "broadsword-class-frigate": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Broadsword class was an eighteen-ship British frigate class introduced between 1975 and 1985. All eighteen 4,400-tonne gas-turbine ships remained active as towed-array submarine hunters and point-defense escorts.",
    canon:"The eighteen-ship roster, individual commissioning years, 4,400-tonne full-load displacement, gas-turbine propulsion, towed-array submarine-hunter and point-defense roles, and eighteen active ships in 1985 are established. Dimensions, speed, weapons, sonar models, helicopters, crew, builders, deployments, refits, and individual histories remain open.",
    sections:[
  ...
  "british-nuclear-attack-submarines": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"British nuclear attack submarines comprised the Valiant, Churchill, and Trafalgar classes. Sixteen boats remained active in 1985, providing long-endurance submarine hunting, carrier screening, reconnaissance, and distant fleet attack.",
    canon:"The three classes, build totals, introduction bands, submerged displacements, individual rosters and commissioning years, nuclear propulsion, quiet attack role, and sixteen-boat 1985 active total are established. Reactor types, dimensions, speeds, crews, weapons, sensors, noise figures, patrol areas, refits, and individual operational histories remain open.",
    sections:[
  ...
  "valiant-class-submarine": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Valiant class comprised six British nuclear attack submarines: Valiant, Warspite, Dreadnought, Conqueror, Courageous, and Centurion. The class occupied the registered 1963–1970 introduction band, and all six 4,900-tonne boats remained active in 1985.",
    canon:"The six-boat roster and individual commissioning years, 1963–1970 introduction band, 4,900-tonne submerged displacement, nuclear propulsion, fleet-attack role, and six active boats are established. Dimensions, reactor, speed, diving depth, crew, weapons, sensors, noise performance, builders, patrols, refits, and individual histories remain open.",
    sections:[
  ...
  "churchill-class-submarine": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Churchill class comprised six British nuclear attack submarines named for national military and political figures. The class occupied the registered 1970–1977 introduction band, and all six 5,000-tonne boats remained active in 1985.",
    canon:"The six-boat roster and individual commissioning years, 1970–1977 introduction band, 5,000-tonne submerged displacement, nuclear propulsion, fleet-attack role, and six active boats are established. Dimensions, reactor, speed, diving depth, crew, weapons, sensors, noise performance, builders, patrols, refits, and individual histories remain open.",
    sections:[
  ...
  "trafalgar-class-submarine": britishNavalArticle({
    ...
    landscape:britishLineageLandscape,
    lead:"The Trafalgar class comprised the British nuclear attack submarines Trafalgar, Turbulent, Tireless, and Torbay. The class occupied the registered 1981–1985 introduction band, and all four 5,300-tonne boats remained active as Britain's newest quiet SSN generation.",
    canon:"The four-boat roster and individual commissioning years, 1981–1985 introduction band, 5,300-tonne submerged displacement, nuclear propulsion, newest quiet fleet-attack role, and four active boats are established. Dimensions, reactor, speed, diving depth, crew, weapons, sensors, acoustic performance, builders, patrols, refits, and individual histories remain open.",
    sections:[
