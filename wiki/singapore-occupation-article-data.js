...
Object.assign(window.deepArticles,{
  ...
  "japanese-twenty-fifth-army":singaporeOccupationArticle({
    ...
    lead:"The Japanese Twenty-Fifth Army was the Imperial Japanese Army formation that conquered Malaya and Singapore during the Limited Southern War. Commanded by Lieutenant General Tomoyuki Yamashita, it combined divisions, armor, artillery, engineers, aviation support, transport, and intelligence in a rapid peninsula campaign followed by the Johore Strait assault. Its victory founded the southern imperial order while its troops and security agencies became responsible for captivity, coercion, and mass violence.",
