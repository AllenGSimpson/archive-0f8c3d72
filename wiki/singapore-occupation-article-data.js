...
Object.assign(window.deepArticles,{
  ...
  "japanese-twenty-fifth-army":singaporeOccupationArticle({
    ...
    lead:"The Japanese Twenty-Fifth Army was the Imperial Japanese Army formation that conquered Malaya and Singapore during the Limited Southern War. Commanded by Lieutenant General <a href='tomoyuki-yamashita.html'>Tomoyuki Yamashita</a>, it combined the <a href='japanese-5th-division.html'>5th Division</a>, <a href='japanese-18th-division.html'>18th Division</a>, <a href='japanese-imperial-guards-division.html'>Imperial Guards Division</a>, armor, artillery, engineers, aviation support, transport, and intelligence in a rapid peninsula campaign followed by the Johore Strait assault. Its victory founded the southern imperial order while its troops and security agencies became responsible for captivity, coercion, and mass violence.",
    ...
    related:[{href:"tomoyuki-yamashita.html",kicker:"Army commander",label:"Tomoyuki Yamashita"},{href:"japanese-landings-singapore.html",kicker:"Culminating assault",label:"Japanese Landings on Singapore"},{href:"shonan-military-administration.html",kicker:"Occupation successor",label:"Shōnan Military Administration"}],
...
if (fallOfSingaporeOccupation) {
  ...
  if (occupationSection) {
    occupationSection.html = "<p>The <a href='shonan-military-administration.html'>Shōnan military administration</a> converted Singapore from British fleet base into the headquarters and clearing center of the southern empire. Port, shipping, intelligence, military command, and Japanese corporate networks converged there while the <a href='singapore-occupation-economy.html'>wartime economy</a> operated through rationing, requisition, inflation, and compulsory currency.<sup class='canon-note' data-provenance='e'>[e]</sup></p><p>The <a href='sook-ching-massacre.html'>Sook Ching massacre</a>, <a href='changi-prisoner-system.html'>Changi captivity</a>, and other coercive systems accompanied the claim that the city had been liberated from European rule.<sup class='canon-note' data-provenance='e'>[e]</sup></p>";
  }
