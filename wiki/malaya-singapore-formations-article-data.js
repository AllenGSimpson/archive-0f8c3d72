...
Object.assign(window.deepArticles,{
  ...
  "eleventh-indian-infantry-division":malayaFormationArticle({
    ...
    sections:[
      ...
      {id:"jitra",title:"The Jitra defeat",html:"<p>The division occupied the incomplete <a href='battle-of-jitra.html'>Jitra position</a> after political delay had left <a href='operation-matador.html'>Operation Matador</a> unexecuted and <a href='operation-krohcol.html'>Krohcol</a> unable to secure the flank. Rain, disrupted movement, infiltration, tanks, and fragmentary reports produced an early withdrawal order.</p><p>Once guns, headquarters, transport, and infantry crowded the same roads, planned retirement became divisional disorganization.</p>"},
    ...
    related:[{href:"david-murray-lyon.html",kicker:"Opening commander",label:"David Murray-Lyon"},{href:"third-indian-corps.html",kicker:"Higher formation",label:"III Indian Corps"},{href:"lewis-heath.html",kicker:"Corps commander",label:"Lewis Heath"},{href:"operation-matador.html",kicker:"Forward plan",label:"Operation Matador"},{href:"battle-of-jitra.html",kicker:"Opening defeat",label:"Battle of Jitra"},{href:"battle-of-kampar.html",kicker:"Defensive recovery",label:"Battle of Kampar"}],
