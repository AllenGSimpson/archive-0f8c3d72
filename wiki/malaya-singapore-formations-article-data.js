...
Object.assign(window.deepArticles,{
  "japanese-5th-division":malayaFormationArticle({
    ...
    related:[{href:"battle-of-slim-river.html",kicker:"Defining breakthrough",label:"Battle of Slim River"},{href:"battle-of-bukit-timah.html",kicker:"Island culmination",label:"Battle of Bukit Timah"}],
  ...
  "japanese-18th-division":malayaFormationArticle({
    ...
    related:[{href:"kota-bharu-landings.html",kicker:"Opening detachment",label:"Kota Bharu Landings"},{href:"battle-of-pasir-panjang.html",kicker:"Final ridge battle",label:"Battle of Pasir Panjang"}],
  ...
  "japanese-imperial-guards-division":malayaFormationArticle({
    ...
    lead:"The Japanese Imperial Guards Division was the elite-status formation committed to the Malayan Campaign under Lieutenant General Takuma Nishimura. It advanced through the southern peninsula, broke the underprepared Indian position at Muar, fought Australian and Indian troops around Bakri and Parit Sulong, and then attempted the costly crossing at Kranji. Prestige did not prevent tactical crisis: the division's assault at Kranji came close to withdrawal before Commonwealth forces abandoned the coast.",
    ...
    related:[{href:"battle-of-muar.html",kicker:"Peninsula battle",label:"Battle of Muar"},{href:"battle-of-kranji.html",kicker:"Crossing crisis",label:"Battle of Kranji"}],
  ...
  "eleventh-indian-infantry-division":malayaFormationArticle({
    ...
    related:[{href:"battle-of-jitra.html",kicker:"Opening defeat",label:"Battle of Jitra"},{href:"battle-of-kampar.html",kicker:"Defensive recovery",label:"Battle of Kampar"}],
  ...
  "eighth-australian-division":malayaFormationArticle({
    ...
    lead:"The 8th Australian Division was the principal Australian Army formation committed to Malaya and Singapore. Raised for the Second Australian Imperial Force under Major General Gordon Bennett, it deployed the 22nd and 27th Brigades to Malaya while other elements were dispersed across northern Australia and island garrisons. The division fought at Gemas, Muar, Sarimbun, Kranji, and Bukit Timah before most of its Malayan force entered Japanese captivity.",
    ...
    related:[{href:"battle-of-gemas.html",kicker:"First major ground action",label:"Battle of Gemas"},{href:"changi-prisoner-system.html",kicker:"Captivity system",label:"Changi Prisoner System"}],
  ...
  "malay-regiment":malayaFormationArticle({
    ...
    lead:"The Malay Regiment was the locally recruited regular infantry formation whose 1st and 2nd Battalions defended Singapore during the final campaign. Created as an experimental Malay company in 1933 and expanded before the war, it combined Malay other ranks and officers with British command elements. Its stand along Pasir Panjang Ridge and at Bukit Chandu, especially the death of Lieutenant Adnan Saidi, became the principal military foundation myth shared by postwar Malaya and Singapore.",
    ...
    sections:[
      ...
      {id:"adnan",title:"Adnan Saidi and Bukit Chandu",html:"<p>Lieutenant Adnan Saidi led a company sector during the final stand. His troops resisted until ammunition and the position failed, after which Adnan was captured or incapacitated and killed.</p><p>Accounts differ in individual detail, but his refusal to abandon the defense made him the regiment's defining figure.</p>"},
    ...
    related:[{href:"battle-of-pasir-panjang.html",kicker:"Defining battle",label:"Battle of Pasir Panjang"},{href:"malaya.html",kicker:"Successor state",label:"Federated Kingdom of Malaya"}],
