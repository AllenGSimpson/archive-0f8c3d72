...
Object.assign(window.deepArticles,{
  ...
  "chemical-protected-armored-vehicles-india":lineageArticle({
    ...
    lead:"Chemical-protected armored vehicles in India are the sealed, cooled, filtered, washable, and supportable machines developed after chemical warfare during the Northern Indian War. Indian conditions make crew heat endurance and decontamination as important as overpressure: a theoretically sealed vehicle is useless if its crew becomes ineffective after two hours in tropical protective equipment.",
    canon:"The 1963–65 trigger, disputed first use, filtered overpressure, closure and sealing, disappearance of open-topped frontline vehicles, cooling, washable exteriors, filter access, decontamination fittings, specialist reconnaissance and support variants, and state-by-state differences are established. Agents, first user, exact systems, protection standards, introduction dates, and performance remain open.",
    sections:[
      {id:"war",title:"The chemical-war trigger",html:"<p>During the <a href='northern-indian-war.html'>1963–65 Northern Indian War</a>, several states use or prepare chemical weapons against entrenched lines. Each later claims retaliation, accident, captured stocks, or unauthorized local action.</p>"},
      {id:"pressure",title:"Filtered positive pressure",html:"<p>Improved seals, filtered crew air, positive pressure, automatic closure of intakes, and detector interfaces become normal in tanks and command vehicles. The design emphasis is persistent chemical contamination rather than nuclear radiation.</p>"},
      {id:"enclosure",title:"The end of open-topped frontline vehicles",html:"<p>Open carriers and self-propelled guns cannot remain effective in contaminated sectors without exhausting every soldier in individual protection. New frontline designs increasingly enclose crews and transported infantry.</p>"},
      {id:"heat",title:"Cooling is protection",html:"<p>Indian heat, engine temperature, sealed compartments, and protective clothing rapidly degrade judgment and endurance. Larger filtered-air capacity, insulation, water, crew-rest practice, and maintainable cooling become combat requirements.</p>"},
      {id:"surface",title:"Designed to be washed",html:"<p>Simpler stowage, protected intakes, accessible filters, washable surfaces, fewer exposed fabrics, and standardized wash-down connections reduce the contaminated mud and liquid a vehicle carries into its own maintenance system.</p>"},
      {id:"variants",title:"Specialist chemical-support vehicles",html:"<p>Major chassis receive reconnaissance, detection, marking, decontamination, casualty-evacuation, protected-command, and engineer bodies. Standardized families give Congress a particular advantage in producing these variants.</p>"},
      {id:"states",title:"Different national solutions",html:"<p>Congress emphasizes reliable fleet-wide protection; Hindustan installs sophisticated but maintenance-demanding systems; Azad Hind combines Japanese protection with retrofits; Hyderabad exports specialized sealed vehicles; TPS relies more on individual gear, tunnels, and shelters.</p>"},
      {id:"lesson",title:"Why Object 279 remains exceptional",html:"<p>Chemical contamination does not require a four-track nuclear-shock vehicle. Ordinary armored forms can be sealed and cooled. The Indian <a href='object-279-india.html'>Object 279 prototype</a> therefore remains an artillery-zone prestige experiment rather than the model for a service fleet.</p>"}
    ],related:[...lineageRelated,{href:"northern-indian-war.html",kicker:"Originating conflict",label:"Northern Indian War"},{href:"vijaya-tank.html",kicker:"Congress benchmark",label:"Vijaya"},{href:"chelyabinsk-kurgan-congress.html",kicker:"Protected infantry",label:"Chelyabinsk–Kurgan Lineage"},{href:"object-279-india.html",kicker:"Exceptional prototype",label:"Object 279 Project"}],
    facts:[["Primary trigger","Northern Indian War, 1963–1965"],["Principal threat","Persistent chemical contamination"],["Crew protection","Filtered positive pressure and sealing"],["Tropical requirement","Cooling and water"],["Exterior requirement","Washable surfaces and accessible filters"],["Frontline troop carriers","Increasingly enclosed"],["Specialist variants","Reconnaissance, decontamination, evacuation, command, engineer"],["First chemical user","Disputed"]]
  })
});
