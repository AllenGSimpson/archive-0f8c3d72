...
Object.assign(window.deepArticles,{
  ...
  "brightnet":matureAmericanSphereArticle({
    ...
    sections:[
      ...
      {id:"shadow",title:"Going shadow",html:"<p>Users move sensitive political discussion, private communities, unauthorized publication, modding, piracy, and compartmented social identities into unlisted or relayed services. By the early 2000s, moving between bright and shadow roles is ordinary; unwanted linkage between them remains dangerous.</p>"},
  ...
  "corporate-political-blacklists":matureAmericanSphereArticle({
    ...
    sections:[
      ...
      {id:"doxing",title:"Doxing and exposed handles",html:"<p>Doxing links a stable pseudonymous handle to a civil identity. An exposed account can damage employment and political standing; the same disclosure can reveal that an executive, official, or campaign operative participated in a supposedly independent community.</p>"},
      {id:"cleaning",title:"Identity-cleaning services",html:"<p>Commercial firms advertise the removal of damaging network material. They cannot reliably erase distributed ShadowNet copies. Their practical service is often negotiation with employers, providers, or blacklist operators to restore access or mark a person as rehabilitated.</p>"},
