...
Object.assign(window.deepArticles,{
  ...
  "society-of-vietnam":mekongNationalArticle({
    ...
    lead:"Vietnamese society combines Nguyễn dynastic identity, village and provincial institutions, Buddhist, Confucian, Catholic, and local religious life, rapid urban growth, Japanese-facing technical careers, and a three-center cultural geography that prevents one city or region from defining the whole country.",
    ...
    sections:[
      ...
      {id:"religion",title:"Religious and learned traditions",html:"<p>Buddhist institutions, Confucian learning, dynastic rites, local cults, and Catholic communities coexist. Catholic worship retains Latin while Vietnamese serves pastoral and catechetical life; French has no necessary religious privilege.</p>"},
    ...
    related:[...vietnamDepthRelated,{href:"government-of-vietnam.html",kicker:"Political institutions",label:"Government of Vietnam"},{href:"economy-of-vietnam.html",kicker:"Material setting",label:"Economy of Vietnam"},{href:"media-dubbing-mekong-states.html",kicker:"Regional media",label:"Media and Dubbing in the Mekong States"}],
