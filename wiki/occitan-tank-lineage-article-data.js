...
Object.assign(window.deepArticles, {
  "occitan-tank-lineage": occitanTankArticle({
    ...
    lead:"Occitania's tank industry begins with the Toulouse Evacuation of 1946–1947 and the formation of Ateliers Mécaniques d’Occitanie. AMO places the Char 48 Languedoc in service in 1948, develops oscillating-turret medium and light vehicles during the 1950s, returns to a conventional turret with the Char 65 Aquitaine, and enters the 1980s with the 120 mm Char 80 Aigle.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-b4s8z writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The Toulouse Evacuation, participating technical communities, AMO identity, five-vehicle sequence, names, introduction years, combat weights, crew sizes, main armaments, engine outputs, road speeds, 12-round autoloaders on Toulouse and Char Léger, dominance of oscillating turrets in those 1950s families, and the conventional-turret return by 1965 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Detailed evacuation routes, personnel lists, dimensions, armor, ammunition loads, turret mechanisms, autoloader geometry, suspension, fire control, production totals, units, exports, variants, and combat histories remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "char-48-languedoc": occitanTankArticle({
    ...
    lead:"The Char 48 Languedoc is Occitania's 52-tonne five-crew service tank of 1948. Armed with the 90 mm AMO L/50 and powered by a 650 hp petrol engine, it is the first registered production vehicle of Ateliers Mécaniques d’Occitanie after the Toulouse Evacuation.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-c9t5a writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The name, 1948 introduction, 52.0-tonne combat weight, five-person crew, 90 mm AMO L/50, 650 hp petrol engine, 40 km/h road speed, AMO association, and first place in the lineage are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Development chronology, dimensions, armor, ammunition, turret arrangement, suspension, secondary weapons, production total, units, variants, exports, combat history, and retirement remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "char-53-toulouse": occitanTankArticle({
    ...
    lead:"The Char 53 Toulouse is Occitania's 40-tonne four-crew tank of 1953. Its oscillating turret carries a 100 mm AMO L/55 and twelve-round autoloader; a 750 hp petrol engine gives the vehicle a registered road speed of 55 km/h.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-d6u2b writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The name, 1953 introduction, 40.0-tonne combat weight, four-person crew, oscillating-turret family, 100 mm AMO L/55, twelve-round autoloader, 750 hp petrol engine, 55 km/h road speed, and AMO association are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, armor, turret geometry, loading cycle, magazine and replenishment arrangements, ammunition, suspension, sights, secondary weapons, production total, units, variants, exports, combat history, and retirement remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "char-leger-55": occitanTankArticle({
    ...
    lead:"The Char Léger 55 is Occitania's 15-tonne three-crew light tank of 1955. An oscillating turret carries a 75 mm AMO L/60 and twelve-round autoloader; its 300 hp petrol engine supports a registered road speed of 60 km/h.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-e3v7c writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The name, 1955 introduction, light-tank role, 15.0-tonne combat weight, three-person crew, oscillating-turret family, 75 mm AMO L/60, twelve-round autoloader, 300 hp petrol engine, 60 km/h road speed, and AMO association are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, armor, turret and loading mechanisms, ammunition, suspension, transport method, tactical doctrine, production total, units, variants, exports, combat history, and retirement remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "char-65-aquitaine": occitanTankArticle({
    ...
    lead:"The Char 65 Aquitaine is Occitania's 38-tonne four-crew tank of 1965. It returns AMO production to a conventional turret and carries a 105 mm AMO L/52; a 720 hp diesel gives it a registered road speed of 65 km/h.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-f8w4d writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The name, 1965 introduction, 38.0-tonne combat weight, four-person crew, conventional-turret position, 105 mm AMO L/52, 720 hp diesel, 65 km/h road speed, AMO association, and place after the oscillating-turret period are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, armor, stabilization details, NBC system, ammunition, suspension, sights, secondary weapons, production total, units, variants, exports, combat history, and retirement remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
  ...
  "char-80-aigle": occitanTankArticle({
    ...
    lead:"The Char 80 Aigle is Occitania's 52-tonne four-crew tank of 1980 and the latest AMO production vehicle registered by 1985. Its conventional turret carries a 120 mm AMO L/44 smoothbore, while a 1,200 hp diesel supports a road speed of 68 km/h.<sup class='canon-note' data-provenance='a'>[a]</sup>",
    canon:"<!-- altwwii-writer-block:start id=wb-g-20260815-g5x9e writer=g kind=revision created=2026-08-15T21:10:00-06:00 -->The name, 1980 introduction, 52.0-tonne combat weight, four-person crew, conventional-turret lineage, 120 mm AMO L/44 smoothbore, 1,200 hp diesel, 68 km/h road speed, AMO association, and status as the latest registered Occitan tank by 1985 are fixed.<sup class='canon-note' data-provenance='a'>[a]</sup> Dimensions, armor type and array, ammunition, stabilization, sights, fire control, suspension, secondary weapons, production total, units, variants, exports, combat history, and later development remain open.<sup class='canon-note' data-provenance='e'>[e]</sup><!-- altwwii-writer-block:end -->",
    sections:[
