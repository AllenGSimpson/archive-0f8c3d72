...
Object.assign(window.deepArticles, {
  ...
  "project-switchback": frontierArticle({
    ...
    canon:"The 1993 beginning, Frontier sponsorship, reusable vertical-rocket objective, economic complement to spaceplanes, continued public range support, absence of an early fully reusable super-heavy vehicle, and continued spaceplane primacy through the early 2000s are established. Vehicle names, engine cycle, dimensions, payloads, contractors, test sites, exact test chronology, failures, costs, and first operational reflight remain open under P1-26.",
    sections:[
      ...
      {id:"demonstrators",title:"Demonstrator sequence",html:"<p>The program proceeded from small vertical takeoff and landing demonstrators toward larger ascent-and-return vehicles and a medium launcher with a recoverable first stage. Published chronologies disagree on individual dates and failures.</p><p>No complete formal vehicle registry has been released, and proposed names should not be treated as settled production designations.</p>"},
      ...
      {id:"legacy",title:"Position by the early 2000s",html:"<p>By the early 2000s Switchback had made reusable first-stage operations plausible but had not transformed launch into effortless airline service. Frontier remained principally an orbital spaceplane carrier.</p><p>The program's historical importance lies in making repeated powered recovery a commercial development path without projecting later fully reusable systems backward into the 1990s.</p>"}
    ],
    related:[...frontierRelated,{href:"konrad-voss.html",kicker:"Program sponsor",label:"Konrad Elias Voss"},{href:"national-orbital-carrier.html",kicker:"Institutional setting",label:"National Orbital Carrier"},{href:"frontier-courier.html",kicker:"Spaceplane complement",label:"Frontier Courier"},{href:"american-orbital-vehicle-program.html",kicker:"American reusable-flight tradition",label:"American Orbital Vehicle Program"}],
    facts:[["Begun","1993"],["Sponsor","Frontier Orbital Lines"],["Type","Reusable vertical-launch research"],["Primary objective","Recoverable first stage"],["Upper stage","Initially expendable"],["Commercial role","Bulk and one-way orbital lift"],["Relationship to spaceplanes","Complementary"],["Exact vehicle specifications","Not publicly settled"]],
