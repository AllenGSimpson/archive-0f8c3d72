...
Object.assign(window.deepArticles, {
  "konrad-voss": frontierArticle({
    ...
    sections:[
      ...
      {id:"legacy",title:"Vehicles, annex, and legacy",html:"<p>Under Voss, Frontier sponsored and operated <a href='frontier-courier.html'>Courier</a>, <a href='frontier-caravan.html'>Caravan</a>, and <a href='frontier-wayfarer.html'>Wayfarer</a>, attached the <a href='frontier-annex.html'>Frontier Annex</a> to Columbia, and began <a href='project-switchback.html'>Project Switchback</a>. Established American aviation firms remained the clean-sheet design and manufacturing houses; the exact prime contractor for each Frontier vehicle is not fixed.</p><p>His central achievement was institutional rather than romantic: the boom financed the company, the crash made its services indispensable, and recovery allowed it to absorb much of the private orbital supply system.<sup class='canon-note' data-provenance='a'>[a]</sup></p>"}
    ],
    ...
    facts:[["Nationality","American"],["Known as","Con Voss"],["Occupation","Aerospace industrialist"],["Company","Frontier Orbital Lines"],["Company founded","1985"],["Initial fleet","Two O-3A and one O-3B"],["National charter","1993"],["Known for","Scheduled private orbital transport"]],
  ...
  "frontier-courier": frontierArticle({
    ...
    lead:"Courier is Frontier Orbital Lines' first proprietary specialized orbital-vehicle program, sponsored in 1988–1989 for urgent automatic satellite delivery, retrieval, and high-value return cargo. It applies the American runway-to-orbit tradition to a narrower commercial mission than the government Liberty family. Courier's significance lies in standard schedules and interfaces rather than a radical new propulsion architecture.",
    canon:"The Courier name, 1988–1989 development period, Frontier sponsorship and ownership, urgent automatic satellite and return-cargo role, relationship to the Liberty-derived operating system, and place before Caravan and Wayfarer are established. The prime contractor, gross mass, payload, dimensions, engines, fleet total, exact first flight, and individual vehicle names remain open under P1-26.",
    sections:[
      ...
      {id:"development",title:"Development in 1988–1989",html:"<p>Courier emerged during the World Market Boom as Frontier's first effort to set and finance a vehicle requirement rather than merely operate transferred government aircraft. A traditional American aviation contractor carried clean-sheet design authority, using American spaceplane knowledge, Canaveral infrastructure, Columbia docking standards, and certified suppliers; the selected firm remains open.</p><p>Its exact prototype and service dates remain disputed in surviving company chronologies.<sup class='canon-note' data-provenance='a'>[a]</sup></p>"},
    ...
    facts:[["Program sponsor and operator","Frontier Orbital Lines"],["Prime contractor","Open"],["Development","1988–1989"],["Type","Commercial orbital aircraft"],["Primary operation","Automatic / uncrewed"],["Principal mission","Urgent satellite delivery and retrieval"],["Return role","High-value cargo"],["Traffic authority","United States Aerospace Force"]]
  }),
  ...
  "frontier-caravan": frontierArticle({
    ...
    lead:"Caravan is Frontier Orbital Lines' proprietary bulk orbital-freighter program, sponsored between 1991 and 1993 as government and corporate traffic to Orbital Port Columbia expanded during the Open Door Depression. Unlike Courier's urgent high-value missions, Caravan was organized around standardized station freight, replaceable cargo units, and dependable capacity purchased through long contracts.",
    canon:"The Caravan name, 1991–1993 development, Frontier sponsorship and ownership, bulk-station-freight role, depression-era origin, relationship to Columbia, and later service alongside Wayfarer are established. The prime contractor, airframe geometry, launch arrangement, automation level, payload, fleet size, first operational mission, and individual vehicles remain open under P1-26.",
    sections:[
      ...
      {id:"development",title:"Development from 1991 to 1993",html:"<p>Frontier sponsored Caravan while acquiring distressed servicing facilities, suppliers, and government-derived equipment. A traditional aviation design house translated the carrier's requirement into an aircraft; its identity remains open. The project drew on Liberty experience and Courier interface standards but addressed a different market: regular bulk freight rather than urgent satellite work.<sup class='canon-note' data-provenance='a'>[a]</sup></p>"},
    ...
    facts:[["Program sponsor and operator","Frontier Orbital Lines"],["Prime contractor","Open"],["Development","1991–1993"],["Type","Commercial orbital freighter"],["Principal mission","Bulk station freight"],["Primary destination","Orbital Port Columbia"],["Commercial model","Scheduled shared capacity"],["Charter context","National Orbital Carrier"]]
  }),
  ...
  "frontier-wayfarer": frontierArticle({
    ...
    lead:"Wayfarer is Frontier Orbital Lines' proprietary crew-transport program, sponsored from 1994 to 1996 for station crews, corporate mission specialists, technicians, physicians, media personnel, and other professional travelers. It represents the point at which private orbital transport becomes a regular personnel service, though not an ordinary tourist market.",
    canon:"The Wayfarer name, 1994–1996 development, Frontier sponsorship and ownership, crew and corporate-specialist role, relationship to Columbia and the Frontier Annex, and position after Courier and Caravan are established. The prime contractor, crew capacity, payload, dimensions, flight deck, life support endurance, fleet total, first mission, and fare structure remain open under P1-26.",
    sections:[
      ...
      {id:"development",title:"Development from 1994 to 1996",html:"<p>Wayfarer followed the cargo-oriented Courier and Caravan after Frontier had accumulated nearly a decade of operating experience. Frontier set the service requirement and financed the program while an established aviation design house retained clean-sheet design authority; the prime contractor remains open. The program matured alongside the Frontier Annex and the growing private presence at Columbia.<sup class='canon-note' data-provenance='a'>[a]</sup></p>"},
    ...
    facts:[["Program sponsor and operator","Frontier Orbital Lines"],["Prime contractor","Open"],["Development","1994–1996"],["Type","Commercial crew transport"],["Passengers","Professional mission specialists"],["Principal destination","Orbital Port Columbia"],["Commercial destination","Frontier Annex"],["Tourist role","Secondary and limited"]]
  }),
