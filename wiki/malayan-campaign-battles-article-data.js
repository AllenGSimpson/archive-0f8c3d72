...
Object.assign(window.deepArticles,{
  ...
  "battle-of-jitra":malayanBattleArticle({
    ...
    lead:"The Battle of Jitra was the defeat of the 11th Indian Infantry Division in northern Kedah during the first week of the Malayan Campaign. A partially prepared defensive position, exhausted units, rain, uncertain communications, Japanese infiltration, and armored pressure produced a premature withdrawal that opened the road toward Penang and central Malaya.",
    canon:"The 11–13 December period, 11th Indian Division defense, Japanese 5th Division pressure, incomplete position, armor and infiltration, confused withdrawal, and strategic loss of northern Kedah are retained. Exact alternate Japanese reserves and casualty totals remain open; the no-Philippines strategy strengthens the campaign system without requiring every tactical event to differ from the recorded battle.",
    sections:[
      {id:"matador",title:"The abandoned forward move",html:"<p>British planning had considered Operation Matador, an advance into southern Thailand to deny Japanese landing grounds and road access. Political delay and operational uncertainty left the force neither firmly forward nor fully prepared on the Jitra line when the invasion began.</p>"},
    ...
    related:[{href:"kota-bharu-landings.html",kicker:"Opening action",label:"Kota Bharu Landings"},{href:"battle-of-kampar.html",kicker:"Next strong position",label:"Battle of Kampar"}],
  ...
  "battle-of-kampar":malayanBattleArticle({
    ...
    canon:"The 30 December–2 January period, strong Kampar position, 11th Indian Division elements, repeated Japanese assaults, effective artillery and defensive fire, local Commonwealth success, and withdrawal after a wider turning threat are retained. Exact Japanese losses, alternate reinforcement, and the weight of coastal movement remain open.",
    sections:[
    ...
    related:[{href:"battle-of-jitra.html",kicker:"Earlier defeat",label:"Battle of Jitra"},{href:"battle-of-slim-river.html",kicker:"Next decisive action",label:"Battle of Slim River"}],
  ...
  "battle-of-slim-river":malayanBattleArticle({
    ...
    related:[{href:"battle-of-kampar.html",kicker:"Preceding defense",label:"Battle of Kampar"},{href:"battle-of-gemas.html",kicker:"Australian delaying action",label:"Battle of Gemas"}],
  ...
  "battle-of-gemas":malayanBattleArticle({
    ...
    lead:"The Battle of Gemas was the Australian ambush at Gemencheh Bridge and the subsequent fighting east of Gemas. The 2/30th Australian Infantry Battalion allowed Japanese advance elements into a prepared killing ground, opened fire, and demolished the bridge. The action inflicted a sharp tactical reverse but did not stop the Japanese campaign once engineers restored the crossing.",
    ...
    related:[{href:"battle-of-slim-river.html",kicker:"Northern breakthrough",label:"Battle of Slim River"},{href:"battle-of-muar.html",kicker:"Wider Johore fighting",label:"Battle of Muar"}],
  ...
  "battle-of-muar":malayanBattleArticle({
    ...
    lead:"The Battle of Muar was the last major battle of the Malayan Campaign before the retreat to Singapore. The Japanese Imperial Guards Division broke the underprepared 45th Indian Infantry Brigade near the Muar River, but Australian and Indian troops fought severe actions at Bakri and along the road to Parit Sulong. Lieutenant Colonel Charles Anderson led the trapped force in a fighting withdrawal before ordering the survivors to escape through Japanese lines.",
    ...
    related:[{href:"battle-of-gemas.html",kicker:"Parallel delaying action",label:"Battle of Gemas"},{href:"parit-sulong-massacre.html",kicker:"Atrocity after the withdrawal",label:"Parit Sulong Massacre"}],
  ...
  "parit-sulong-massacre":malayanBattleArticle({
    ...
    related:[{href:"battle-of-muar.html",kicker:"Preceding battle",label:"Battle of Muar"},{href:"japanese-war-memory.html",kicker:"Contested remembrance",label:"Japanese War Memory"}],
