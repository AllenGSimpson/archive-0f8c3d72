...
const americanReusableResearchLandscape = {
  ...
  alt:"Four American reusable-aerospace research paths from X-15A, X-20A Dyna-Soar, the X-24 series, and Project Apex converging on XO-1 Pathfinder in 1969",
...
Object.assign(window.deepArticles, {
  "american-reusable-aerospace-research-generation": americanReusableResearchArticle({
    ...
    sections:[
      ...
      {id:"convergence",title:"Convergence on Pathfinder",html:"<!-- altwwii-writer-block:start id=wb-g-20260815-z4n8k writer=g kind=revision created=2026-08-15T11:57:55-06:00 --><p><a href='ov-1a-pathfinder.html'>XO-1 Pathfinder</a> combines the generation's lessons in the first American aircraft to take off horizontally under integrated propulsion, achieve stable orbit, reenter, and land on a runway in 1969. X-15 contributes piloted hypersonics and energy management. X-20 supplies orbital-glide and inspection experience. X-24 contributes lifting-body and integrated-propulsion work. Apex supplies full-scale runway launch, mode transition, thermal structure, and compact flight computing.</p><!-- altwwii-writer-block:end -->"},
    ...
    facts:[["Period","1961–1969"],["Research paths","Four"],["Rocketplane","X-15A"],["Boosted glider","X-20A Dyna-Soar"],["Lifting body","X-24 series"],["Runway demonstrators","Project Apex"],["Orbital convergence","XO-1 Pathfinder"],["Surviving architecture","Self-powered runway-to-orbit flight"]]
  }),
  ...
  "project-apex": americanReusableResearchType({
    ...
    lineageTitle:"From strategic experiment to orbital transport",lineageHtml:"<!-- altwwii-writer-block:start id=wb-g-20260815-c9r2m writer=g kind=revision created=2026-08-15T11:57:55-06:00 --><p>Apex fails to restore permanent sanctuary above air defenses, but it establishes the runway-launch, propulsion-transition, thermal, guidance, simulation, and maintenance knowledge used by <a href='ov-1a-pathfinder.html'>XO-1 Pathfinder</a>. A strategic response to Maracaibo becomes an enabling step for the general American orbital-vehicle system.</p><!-- altwwii-writer-block:end -->",
