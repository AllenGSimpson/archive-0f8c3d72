...
const americanReusableResearchLandscape = {
  ...
  alt:"Four American reusable-aerospace research paths from X-15A, X-20A Dyna-Soar, the X-24 series, and Project Apex converging on OV-1A Pathfinder in 1969",
...
const americanReusableResearchType = c => americanReusableResearchArticle({
  ...
  lead:c.lead,
  canon:`The ${c.period} program period, ${c.role.toLowerCase()} role, ${c.launch.toLowerCase()} launch method, ${c.recovery.toLowerCase()} recovery method, and registered contribution to Pathfinder are fixed. ${c.fixed || "The broad historical manufacturer and technical foundation are retained where compatible."} Exact airframe count, dimensions, propulsion details, individual flights, crews, test sites beyond those named, accidents, contractors, budgets, and retirement remain open unless separately established.`,
  sections:[
  ...
  facts:[["Country","United States"],["Service","United States Aerospace Force"],["Period",c.period],["Role",c.role],["Launch",c.launch],["Recovery",c.recovery],["Operating regime",c.regime],["Contribution",c.contribution]]
});
...
Object.assign(window.deepArticles, {
  "american-reusable-aerospace-research-generation": americanReusableResearchArticle({
    ...
    lead:"The American reusable-aerospace research generation was the four-path experimental program that preceded OV-1A Pathfinder. X-15A studied piloted hypersonic flight and energy-managed return; X-20A Dyna-Soar tested boosted orbital glide; the X-24 series developed lifting-body and integrated-propulsion behavior; and Project Apex joined full-scale combined-cycle propulsion, thermal structure, and runway-launched upper-atmosphere testing. Pathfinder inherited results from all four without preserving every vehicle's configuration.",
    canon:"The four research paths, program years, distinct launch and recovery methods, technical contributions, X-20's status as the last major boosted glider rather than the surviving operational architecture, Apex's post-Maracaibo strategic setting, and convergence on OV-1A Pathfinder are fixed. Broad historical X-15, Dyna-Soar, and lifting-body design foundations are retained where compatible. Exact budgets, institutional divisions, vehicle counts, contractors, flight lists, accidents, crews, reports, and technology-transfer records remain open.",
    sections:[
      ...
      {id:"convergence",title:"Convergence on Pathfinder",html:"<p><a href='ov-1a-pathfinder.html'>OV-1A Pathfinder</a> combines the generation's lessons into the first true runway-to-orbit American aircraft in 1969. X-15 contributes piloted hypersonics and energy management; X-20 orbital glide and inspection; X-24 lifting-body and integrated-propulsion work; Apex full-scale runway launch, mode transition, thermal structure, and compact flight computing.</p>"},
      {id:"limits",title:"A lineage without false inevitability",html:"<p>The four paths are not consecutive production prototypes. Some solutions conflict, several arrangements end, and the operational vehicle requires new engineering beyond all of them. The register fixes technical inheritance without claiming that Pathfinder was a simple enlargement of any one predecessor.</p>"}
    ],
    related:[{href:"ov-1a-pathfinder.html",kicker:"1969 convergence",label:"OV-1A Pathfinder"},{href:"american-orbital-vehicle-program.html",kicker:"Operational lineage",label:"American Orbital Vehicle Program"},{href:"american-aerospace-force-atmospheric-fleet.html",kicker:"Strategic-air context",label:"Aerospace Force Atmospheric Fleet"},{href:"maracaibo-shock.html",kicker:"1966 doctrinal rupture",label:"Maracaibo Shock"},{href:"aerospace-doctrine.html",kicker:"Strategic framework",label:"Aerospace Doctrine of the United States"},{href:"canaveral-aerospace-field.html",kicker:"Operational successor base",label:"Canaveral Aerospace Field"}],
    ...
    facts:[["Period","1961–1969"],["Research paths","Four"],["Rocketplane","X-15A"],["Boosted glider","X-20A Dyna-Soar"],["Lifting body","X-24 series"],["Runway demonstrators","Project Apex"],["Operational convergence","OV-1A Pathfinder"],["Surviving architecture","Self-powered runway-to-orbit flight"]]
  }),
  ...
  "x-15a": americanReusableResearchType({
    ...
    related:[{href:"nf-104a-starfighter.html",kicker:"Aerospace-training contemporary",label:"NF-104A Starfighter"},{href:"ov-1a-pathfinder.html",kicker:"Operational successor",label:"OV-1A Pathfinder"}]
  }),
  ...
  "x-20a-dyna-soar": americanReusableResearchType({
    ...
    related:[{href:"project-apex.html",kicker:"Runway-launched successor research",label:"Project Apex"},{href:"ov-1a-pathfinder.html",kicker:"Operational successor",label:"OV-1A Pathfinder"}]
  }),
  ...
  "project-apex": americanReusableResearchType({
    ...
    lineageTitle:"From strategic experiment to orbital transport",lineageHtml:"<p>Apex fails to restore permanent sanctuary above air defenses, but it establishes the runway-launch, propulsion-transition, thermal, guidance, simulation, and maintenance knowledge used by <a href='ov-1a-pathfinder.html'>Pathfinder</a>. A strategic response to Maracaibo therefore becomes an enabling step for the general American orbital-vehicle system.</p>",
    related:[{href:"maracaibo-shock.html",kicker:"Doctrinal cause",label:"Maracaibo Shock"},{href:"ov-1a-pathfinder.html",kicker:"1969 operational convergence",label:"OV-1A Pathfinder"}]
  })
});
