...
Object.assign(window.deepArticles, {
  "jose-larraz": spanishFinancialBiography({
    ...
    sections:[
      ...
      {id:"coalition",title:"Economic-policy coalition",html:"<p>Larraz supplied the fiscal pole of a balance that also included <a href='antonio-goicoechea.html'>Antonio Goicoechea</a> in banking, <a href='demetrio-carceller.html'>Demetrio Carceller</a> in trade and supplies, and <a href='juan-antonio-suanzes.html'>Juan Antonio Suanzes</a> in state industry. He did not eliminate autarkic policy, but insisted that industrial sovereignty required a functioning currency and Treasury.</p>"},
