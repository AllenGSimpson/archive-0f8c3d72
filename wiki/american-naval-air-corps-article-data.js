...
const americanNavalAirType = c => americanNavalAirArticle({
  title:c.title,
  eyebrow:c.eyebrow || `United States Naval Air Corps · introduced ${c.year}`,
  infoboxKicker:c.kicker,
  infoboxTitle:c.title,
  lead:c.lead,
  canon:c.canon || `Direct canon preserves Navy ownership of fleet aviation but does not directly fix this type's ${c.year} introduction, ${c.mission.toLowerCase()} mission, ${c.speed} maximum speed, ${c.radius} combat radius, ${c.load.toLowerCase()}, operating basis, manufacturer, configuration, or service history. Those fields are incorporated reconstruction; production, squadrons, carriers or bases, operations, losses, variants, upgrades, and retirement remain open.`,
  sections:[
  ...
  facts:c.facts || [["Canon status","Incorporated naval-air register"],["Working service","United States Naval Air Corps"],["Working introduction",String(c.year)],["Working operating basis",c.basis],["Working mission",c.mission],["Working maximum speed",c.speed],["Working combat radius",c.radius],["Working armament or load",c.load]]
});
...
Object.assign(window.deepArticles, {
  "american-naval-air-corps-force": americanNavalAirArticle({
    ...
    eyebrow:"Carrier and maritime aviation · common-register era",
    infoboxKicker:"American fleet-air register",
    infoboxTitle:"Naval Air Corps force",
    landscape:null,
    lead:"The United States Naval Air Corps remained the Navy's fixed-wing aviation system. Its detailed mature register combines carrier and maritime aircraft with incorporated F-10, F-11, F-14, and F-18 assignments from the proposed Teen-Series map.<sup class='canon-note' data-provenance='e'>[e]</sup>",
    canon:"Continued Naval Air Corps ownership of fleet aviation is directly established. The complete aircraft table, exact dates and performance, F-10/F-11 redesignations, F-14/F-18 assignments and roles, common-register mechanism, procurement, squadrons, carriers, bases, operations, losses, exports, upgrades, and retirement are incorporated extrapolation or open according to their dedicated pages.",
    sections:[
      {id:"source-status",title:"Canon status of the register",html:"<!-- altwwii-writer-block:start id=wb-g-20260816-sn5p6 writer=g kind=revision created=2026-08-16T11:15:00-06:00 --><p>Direct canon preserves Navy ownership of fleet aviation.<sup class='canon-note' data-provenance='a'>[a]</sup> It does not fix the F-10, F-11, F-14, and F-18 assignments or the complete layered aircraft table; those elements retain their dedicated-page status as incorporated reconstruction.<sup class='canon-note' data-provenance='e'>[e]</sup></p><!-- altwwii-writer-block:end -->"},
      ...
      {id:"register",title:"Working combat and support register",html:"<div class='table-wrap'><table class='wiki-table'><thead><tr><th>Aircraft</th><th>Date</th><th>Mission or register status</th><th>Basis</th></tr></thead><tbody><tr><td><a href='fj-1-fury.html'>FJ-1 Fury</a></td><td>1948</td><td>First operational carrier jet</td><td>Carrier</td></tr><tr><td><a href='f2h-2-banshee.html'>F2H-2 Banshee</a></td><td>1952</td><td>Carrier fighter and escort</td><td>Carrier</td></tr><tr><td><a href='f3d-1-skyknight.html'>F3D-1 Skyknight</a></td><td>1952</td><td>All-weather fleet defense</td><td>Carrier</td></tr><tr><td><a href='f7u-3-cutlass.html'>F7U-3 Cutlass</a></td><td>1955</td><td>Limited tailless carrier fighter</td><td>Carrier</td></tr><tr><td><a href='f-10-skyknight.html'>F-10 Skyknight</a></td><td>1963</td><td>Proposed redesignation</td><td>Carrier or shore</td></tr><tr><td><a href='f-11a-tiger.html'>F-11A Tiger</a></td><td>1963</td><td>Proposed lightweight fighter</td><td>Carrier</td></tr><tr><td><a href='a-6e-intruder.html'>A-6E Intruder</a></td><td>1971</td><td>All-weather maritime strike</td><td>Carrier</td></tr><tr><td><a href='p-3c-orion.html'>P-3C Orion</a></td><td>1973</td><td>Maritime patrol and antisubmarine warfare</td><td>Land</td></tr><tr><td><a href='f-14a-tomcat.html'>F-14A Tomcat</a></td><td>1974</td><td>Proposed fleet-defense fighter</td><td>Carrier</td></tr><tr><td><a href='e-2c-hawkeye.html'>E-2C Hawkeye</a></td><td>1975</td><td>Carrier airborne early warning</td><td>Carrier</td></tr><tr><td><a href='f-18a-hornet.html'>F-18A Hornet</a></td><td>Not fixed</td><td>Proposed medium carrier fighter</td><td>Carrier</td></tr></tbody></table></div><p>The Teen-Series rows are incorporated reconstruction.<sup class='canon-note' data-provenance='e'>[e]</sup></p>"},
      {id:"first",title:"The first carrier-jet generation",html:"<p>Fury proves that an operational jet can launch, recover, and fit aboard the carrier. Banshee adds range, altitude, escort, and a heavier cannon battery. Skyknight adds radar-directed all-weather defense and later enters the common register as F-10. Cutlass tests swept, tailless, and afterburning ideas but remains a deliberately limited fleet type; F-11 Tiger supplies the register's lightweight supersonic carrier-fighter prologue.</p>"},
      ...
      {id:"mature",title:"The mature carrier air group",html:"<p>The proposed Tomcat and Hornet roles within the layered Intruder and Hawkeye force are incorporated reconstruction.<sup class='canon-note' data-provenance='e'>[e]</sup></p>"},
      ...
      {id:"limits",title:"Open force structure",html:"<p>The Teen-Series designations, dates, performance, conversion histories, procurement, engines, avionics, production, squadrons, carriers, bases, operations, losses, exports, upgrades, and retirement are not fixed by direct canon.</p>"}
    ],
    related:[{href:"aerospace-doctrine.html",kicker:"Three-service structure",label:"Aerospace Doctrine of the United States"},{href:"joint-aircraft-designation-act.html",kicker:"1963 common register",label:"Joint Aircraft Designation Act"},{href:"teen-series.html",kicker:"Common fighter sequence",label:"Teen Series"},{href:"american-army-air-corps-force.html",kicker:"Battlefield counterpart",label:"Army Air Corps Force"},{href:"f-10-skyknight.html",kicker:"Legacy all-weather number",label:"F-10 Skyknight"},{href:"f-14a-tomcat.html",kicker:"Heavy fleet-defense branch",label:"F-14A Tomcat"},{href:"f-18a-hornet.html",kicker:"Medium fighter branch",label:"F-18A Hornet"},{href:"a-6e-intruder.html",kicker:"Maritime-strike branch",label:"A-6E Intruder"},{href:"p-3c-orion.html",kicker:"Outer patrol branch",label:"P-3C Orion"}],
    ...
    facts:[["Directly established institution","Navy ownership of fleet aviation"],["Working Teen assignments","F-10 · F-11 · F-14 · F-18"],["Working support register","A-6E · P-3C · E-2C"],["Exact designations and specifications","Follow dedicated-page provenance"]]
  }),
  ...
  "f-14a-tomcat": americanNavalAirType({
    ...
    eyebrow:"United States Naval Air Corps · incorporated Teen-Series register",
    lead:"In the incorporated Teen-Series register, F-14A Tomcat was a Naval Air Corps fleet-defense fighter introduced in 1974. Its number, service, date, variable-sweep configuration, performance, crew, and six-missile battery are reconstruction rather than direct canon.<sup class='canon-note' data-provenance='e'>[e]</sup>",
    canon:"Direct canon establishes the F-10 through F-19 interval but does not assign F-14. The Tomcat identity, Naval ownership, 1974 date, mission, configuration, performance, weapons, development history, squadrons, carriers, operations, upgrades, and retirement are incorporated extrapolation or open.",
    sourceStatus:{id:"source-status",title:"Canon status",html:"<!-- altwwii-writer-block:start id=wb-g-20260816-t4r5s writer=g kind=revision created=2026-08-16T11:12:00-06:00 --><p>The author fixes the F-10 through F-19 interval but not an F-14 Tomcat assignment.<sup class='canon-note' data-provenance='a'>[a]</sup> The naval fleet-defense aircraft and its detailed specification remain compatible incorporated reconstruction.<sup class='canon-note' data-provenance='e'>[e]</sup></p><!-- altwwii-writer-block:end -->"},
    ...
    facts:[["Canon status","Incorporated Teen-Series assignment"],["Country of origin","United States"],["Working service","United States Naval Air Corps"],["Working designation","F-14A Tomcat"],["Working introduction","1974"],["Working role","Carrier fleet defense"],["Working performance","2,485 km/h · 925 km radius"],["Working armament","One cannon · six long-range missiles"]],
