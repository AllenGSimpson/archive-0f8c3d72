...
Object.assign(window.deepArticles, {
  ...
  "amman-settlement": middleEastArticle({
    ...
    sections:[
      ...
      {id:"jordan",title:"The Jordanian zone",html:"<p>Jordan receives or retains Jerusalem, the Arab highlands, the Jordan Valley, Gaza, and most or all of the Negev, organized as the kingdom's <a href='western-provinces-jordan.html'>western provinces</a>. The territorial victory also gives Amman a large Palestinian population and lasting representational obligations.</p>"},
    ...
    related:[{href:"israel.html",kicker:"Coastal successor",label:"State of Israel"},{href:"jordan.html",kicker:"Territorial beneficiary",label:"Hashemite Kingdom of Jordan"},{href:"western-provinces-jordan.html",kicker:"Jordanian territory",label:"Western Provinces of Jordan"},{href:"jordanian-nationality-settlement-palestine.html",kicker:"Citizenship settlement",label:"Jordanian Nationality Settlement"},{href:"palestinian-council-jordan.html",kicker:"Representative institution",label:"Palestinian Council of Jordan"}],
  ...
  "operation-covenant": middleEastArticle({
    ...
    sections:[
      ...
      {id:"available-force",title:"Available force and open allocation",html:"<!-- altwwii-writer-block:start id=wb-m-20260816-y4c8n writer=m kind=technical created=2026-08-16T11:50:54-06:00 --><div><p>The 1974 equipment record establishes what Britain could draw upon, rather than which named formation deployed every system. The campaign order of battle remains open. Availability still defines the transport, maintenance, fuel, ammunition, recovery, and training problems that the concentration staff had to solve.</p><div class='table-wrap'><table class='wiki-table'><thead><tr><th>Function</th><th>Confirmed 1974 capability</th><th>Principal theater demand</th></tr></thead><tbody><tr><td>Armored maneuver</td><td>Chieftain Mk 5; FV432; FV435 Cavalier; FV438 Swingfire; FV101 Scorpion; FV107 Scimitar</td><td>Sealift, tracked-vehicle recovery, engines and transmissions, fuel, ammunition, and workshop capacity</td></tr><tr><td>Artillery and mobile fire support</td><td>FV433 Abbot and the newly introduced air-portable and amphibious L118 Light Gun</td><td>Ammunition throughput, survey and communications, towing or air movement, barrel and vehicle maintenance</td></tr><tr><td>Land-based and naval aviation</td><td>Lightning F.3, Buccaneer S.2, TSR-2 B.1, Harrier GR.1, naval Harrier, Victor tankers, and carrier aviation</td><td>Dispersed fields, tanker support, weapons and spare parts, runway repair, air-defense suppression, and sortie generation</td></tr><tr><td>Sea control and amphibious movement</td><td>HMS <em>Commonwealth</em> commissioned in 1973; missile escorts, submarines, Fearless-class landing-platform docks, Round Table landing ships, Ocean-class helicopter assault ships, and fleet auxiliaries were in service</td><td>Escort cover, minesweeping, landing craft, aviation fuel, replenishment, repair, and protected unloading points</td></tr><tr><td>Strategic movement</td><td>Gulf bases linked to Aden, the Indian Ocean, Commonwealth ports, and the Cape route</td><td>Transit rights, port clearance, merchant shipping, local labor, stocks, communications, and cooperation by several governments</td></tr></tbody></table></div></div><!-- altwwii-writer-block:end -->"},
      ...
      {id:"iraqi-system",title:"Iraqi combat power",html:"<!-- altwwii-writer-block:start id=wb-m-20260816-f2j7r writer=m kind=analysis created=2026-08-16T11:50:54-06:00 --><div><p>Iraqi weakness did not make its German-origin equipment imaginary or harmless. The British method was to widen the gap between material capability and sustained formation performance.</p><div class='table-wrap'><table class='wiki-table'><thead><tr><th>Iraqi capability</th><th>Institutional weakness</th><th>Effect under isolation</th></tr></thead><tbody><tr><td>Modern armor, antitank weapons, and artillery</td><td>Insufficient recovery, restricted spares, uneven maintenance, and weak coordination between arms</td><td>Serviceable strength declined as damaged or broken equipment accumulated behind the fighting units</td></tr><tr><td>Aircraft, radar, and guided weapons</td><td>Uneven training, staff integration, repair, and command of the air-defense network</td><td>The systems imposed real cost but could not keep the reinforcement and supply network continuously protected</td></tr><tr><td>Modern communications</td><td>Weak noncommissioned-officer and staff systems and poor combined-arms procedures</td><td>Information did not consistently become timely movement, fire support, repair, or resupply</td></tr><tr><td>A large invading field force</td><td>Fuel, ammunition, transport, and replacement systems unable to match the forward tempo</td><td>Interdiction reduced operational coherence before the frontline formations were physically destroyed</td></tr></tbody></table></div></div><!-- altwwii-writer-block:end -->"},
      ...
      {id:"phases",title:"Operational sequence",html:"<!-- altwwii-writer-block:start id=wb-m-20260816-p8v3d writer=m kind=analysis created=2026-08-16T11:50:54-06:00 --><div><div class='table-wrap'><table class='wiki-table'><thead><tr><th>Period</th><th>Operational purpose</th><th>Sustainment problem</th></tr></thead><tbody><tr><td>September 1974</td><td>Contain al-ʿAwda and prevent a decisive collapse of the protected territory</td><td>Local stocks, command continuity, rapid air movement, air defense, and protection of usable ports and fields</td></tr><tr><td>September–October</td><td>Concentrate Commonwealth forces and isolate the Iraqi army</td><td>Long-distance sealift, tanker support, dispersed aviation, escorts, repair, spares, fuel, and host-government access</td></tr><tr><td>November</td><td>Clear Kuwait under combined-arms pressure</td><td>Ammunition, engineering, medical evacuation, vehicle recovery, and an intact flow through the Gulf bases</td></tr><tr><td>December</td><td>Take or isolate Faw and Umm Qasr and place Basra under operational threat</td><td>Amphibious support, coastal control, bridging and port work, and keeping the advance within its supply and replacement capacity</td></tr><tr><td>Late December</td><td>Convert military leverage into the Muscat Articles and withdraw from occupied Iraqi territory</td><td>Ceasefire control, inspection arrangements, withdrawal schedules, and continued support of the retained Kuwait bases</td></tr></tbody></table></div><p>Threatening Basra achieved the required bargaining effect. Capturing and holding the city would have demanded a larger replacement flow, urban combat forces, an occupation administration, and protection of longer lines inside Iraq. Covenant stopped after Baghdad accepted the boundary, security, inspection, and reparation terms. The limit preserved the coalition and kept German non-intervention credible.</p></div><!-- altwwii-writer-block:end -->"},
    ...
    related:[{href:"kuwait-war.html",kicker:"Parent conflict",label:"Kuwait War"},{href:"indian-school-british-warfare.html",kicker:"Operational inheritance",label:"Indian School of British Warfare"},{href:"route-home-principle.html",kicker:"Limited-war boundary",label:"Route-Home Principle"},{href:"royal-fleet-auxiliary-postwar.html",kicker:"Fleet sustainment",label:"Royal Fleet Auxiliary"},{href:"british-gulf-protected-state-system.html",kicker:"Treaty and basing system",label:"British Gulf Protected-State System"},{href:"muscat-articles.html",kicker:"Resulting settlement",label:"Muscat Articles"},{href:"commonwealth.html",kicker:"Belligerent system",label:"British Commonwealth"}],
  ...
  "suez-regime": middleEastArticle({
    ...
    sections:[
      {id:"conquest",title:"From British artery to Italian center",html:"<p>The <a href='suez-campaign.html'>wartime loss of Egypt and Suez</a> breaks Britain's old Mediterranean route system. Italy converts victory into control of the approaches, bases, air defense, and external security of the canal.</p>"},
      ...
      {id:"egypt",title:"Egyptian administration and reserve policy",html:"<p><a href='egypt.html'>Egyptian ministries</a> and firms participate in canal operation, ports, rail traffic, cotton, banking, and <a href='italian-egyptian-development-board.html'>development boards</a>. Rome retains control of defense, reserve accounts, and deductions that limit Cairo's command over nominal revenue.</p>"},
