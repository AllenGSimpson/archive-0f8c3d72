...
Object.assign(window.deepArticles, {
  "american-artillery": americanArtilleryArticle({
    ...
    sections:[
      ...
      {id:"formation",title:"Armored formations in 1985",html:"<!-- altwwii-writer-block:start id=wb-g-20260815-a4j8n writer=g kind=revision created=2026-08-15T12:45:00-06:00 --><p>M8A2 howitzers provide the principal tracked artillery layer behind armored divisions built around the mature M60 family, M5 battle carriers, M2 Scouts, air-defense guns, missile carriers, helicopters, engineers, and recovery units. M6 batteries add corps fire above that division, while the post-M60 tank competition remains unresolved.</p><!-- altwwii-writer-block:end -->"},
