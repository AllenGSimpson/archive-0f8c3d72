...
Object.assign(window.deepArticles, {
  ...
  "me-501a-1-falke": germanCleanAircraftArticle({
    ...
    sections:[
      ...
      {id:"successor",title:"Interceptor lineage",html:"<p>The 1967 Me 511A-1 Adler later assumes the heavy-interceptor mission. Direct component continuity, upgrade paths, and the timing of Falke's replacement remain open.</p>"},
  ...
  "fw-502a-1-habicht": germanCleanAircraftArticle({
    ...
    sections:[
      ...
      {id:"successor",title:"Later Focke-Wulf fighter branch",html:"<p>The 1969 Fw 512A-1 Sperber and 1980 Fw 522A-1 Habicht II later occupy air-superiority roles. Detailed design ancestry and replacement schedules remain open.</p>"},
  ...
  "ar-503a-1-blitz-ii": germanCleanAircraftArticle({
    ...
    sections:[
      ...
      {id:"successor",title:"Later Arado branch",html:"<p>The Ar 513A-1 Blitz III and Ar 523A-1 Blitz IV later continue theater-strike roles. Exact replacement, shared systems, and production overlap remain open.</p>"},
  ...
  "ju-506a-1": germanCleanAircraftArticle({
    ...
    sections:[
      ...
      {id:"successor",title:"Seeadler succession",html:"<p>The 1972 Ju 516A-1 Seeadler later carries maritime patrol and missile-control duties. Direct design ancestry, shared crews, unit conversion, and overlap remain open.</p>"},
