...
Object.assign(window.deepArticles, {
  ...
  "combat-fragmented-terrain": mittelafrikaArticle({
    ...
    related:[{href:"wehrmacht-congo-generation.html",kicker:"Veteran cohort",label:"Wehrmacht Congo Generation"},{href:"congo-vehicle-crisis.html",kicker:"Formative crisis",label:"Congo Vehicle Crisis"},{href:"jaeger-arm-germany.html",kicker:"Revived arm",label:"Jäger Arm"},{href:"network-isolation-doctrine.html",kicker:"Operational method",label:"Network Isolation Doctrine"},{href:"german-field-recovery.html",kicker:"Technical reform",label:"German Field Recovery"},{href:"kongosee-eingreifgruppe.html",kicker:"Operational prototype",label:"Kongosee-Eingreifgruppe"},{href:"military-technology.html",kicker:"Capability context",label:"Military Technology"},{href:"war-of-the-chiefs.html",kicker:"Founding campaign",label:"War of the Chiefs"}],
