...
Object.assign(window.deepArticles, {
  ...
  "combat-fragmented-terrain": mittelafrikaArticle({
    ...
    sections:[
      {id:"failure",title:"Failure of universal mechanization",html:"<p>In 1972–73 heavy columns discover that roads behave like ambush canals, bridges and barges determine movement, and a protected vehicle beyond recoverable access is a liability regardless of battlefield quality.</p>"},
      {id:"mobility",title:"Mobility redefined",html:"<p>The doctrine does not reject mechanization. It combines light patrols, local intelligence, aircraft, boats, dismounted infantry, engineers, and selective mechanized concentration according to the terrain and network.</p>"},
      ...
      {id:"nodes",title:"Networks rather than fronts",html:"<p>Control of markets, fuel, communications, ferries, channels, hospitals, landing places, and political brokers can isolate resistance without occupying every kilometre of forest or shoreline.</p>"},
      ...
      {id:"maintenance",title:"Maintenance as combat arm",html:"<p>Floating workshops, forward recovery, modular engine replacement, filtration, sealing, corrosion control, medical support, and helicopter delivery of critical parts become operational capabilities rather than rear services.</p>"},
      {id:"procurement",title:"Procurement consequences",html:"<p>The war favors lighter amphibious protected transport, modular weapons, tropical reliability, useful dismounted equipment, and vehicles judged by lift, draft, bridge load, repair, and shipping footprint. Exact programs remain governed by armaments references.</p>"}
    ],
    related:[{href:"kongosee-eingreifgruppe.html",kicker:"Operational prototype",label:"Kongosee-Eingreifgruppe"},{href:"military-technology.html",kicker:"Capability context",label:"Military Technology"},{href:"war-of-the-chiefs.html",kicker:"Founding campaign",label:"War of the Chiefs"}],
