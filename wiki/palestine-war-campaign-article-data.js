...
Object.assign(window.deepArticles, {
  ...
  "palestinian-displacement-1947-1950": firstPalestineWarArticle({
    ...
    related:[{href:"palestine-war.html",kicker:"Originating conflict",label:"Palestine War"},{href:"jordanian-palestinian-refugee-administration.html",kicker:"Jordanian successor system",label:"Palestinian Refugee Administration"},{href:"jordanian-nationality-settlement-palestine.html",kicker:"Citizenship settlement",label:"Jordanian Nationality Settlement"},{href:"jordan.html",kicker:"Principal receiving state",label:"Hashemite Kingdom of Jordan"},{href:"israel.html",kicker:"Property-controlling state",label:"State of Israel"}],
  ...
  "amman-settlement-negotiations": firstPalestineWarArticle({
    ...
    sections:[
      ...
      {id:"implementation",title:"Implementation",html:"<p>Jordan integrated Arab Palestine through a transitional <a href='arab-palestine-military-administration.html'>military administration</a>, common citizenship, and a <a href='palestinian-council-jordan.html'>western representative chamber</a>. Israel organized a permanently mobilized coastal state. Mixed contacts, foreign pressure, and local arrangements kept the order functioning until Abdullah's assassination reopened the security crisis.</p>"},
    ...
    related:[{href:"amman-settlement.html",kicker:"Settlement overview",label:"Amman Settlement"},{href:"western-provinces-jordan.html",kicker:"Territorial implementation",label:"Western Provinces of Jordan"},{href:"palestinian-council-jordan.html",kicker:"Representative implementation",label:"Palestinian Council of Jordan"},{href:"palestinian-displacement-1947-1950.html",kicker:"Unresolved question",label:"Palestinian Displacement"},{href:"second-israeli-jordanian-war.html",kicker:"First major challenge",label:"Second Israeli–Jordanian War"}],
...
addFirstPalestineWarRelated("amman-settlement",[
  ...
  {href:"jerusalem-under-jordanian-rule.html",kicker:"Principal special regime",label:"Jerusalem under Jordanian Rule"},
  {href:"western-provinces-jordan.html",kicker:"Territorial implementation",label:"Western Provinces of Jordan"},
  {href:"jordanian-nationality-settlement-palestine.html",kicker:"Citizenship implementation",label:"Jordanian Nationality Settlement"}
]);
