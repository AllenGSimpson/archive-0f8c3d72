...
Object.assign(window.deepArticles, {
  ...
  "arab-legion-palestine-war": firstPalestineWarArticle({
    ...
    sections:[
      ...
      {id:"coalition",title:"Relations with other Arab forces",html:"<p>Egyptian, Iraqi, Syrian, Lebanese, Palestinian, and volunteer formations pursued different objectives and answered to separate governments. The Legion coordinated locally but resisted schemes that would subordinate Abdullah's territorial program to a single Arab revolutionary authority.</p>"},
