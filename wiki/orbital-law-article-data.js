...
Object.assign(window.deepArticles, {
  "orbital-law": orbitalLawArticle({
    ...
    sections:[
      ...
      {id:"jurisdiction",title:"Jurisdiction and station authority",html:"<p>Ordinary civil and criminal jurisdiction generally follows the responsible vehicle or module government. A station's integrated commander retains technical emergency authority where life support, power, attitude, docking, or collision risk makes divided command impossible.</p>"},
  ...
  "orbital-weapons": orbitalLawArticle({
    ...
    sections:[
      ...
      {id:"america",title:"American Project Zenith",html:"<p>The OSV-1A Zenith reaches limited readiness in 1984. Its missions include armed inspection, reconnaissance, rescue, electronic warfare, controlled deorbit, and conventional guided reentry attack. It shares operational ancestry with Columbia but belongs to Orbital Security Command.</p>"},
      {id:"japan",title:"Japanese autonomous interceptors",html:"<p>Japan moves toward a laser-relay network supervising unmanned Type 48 Raiden interceptors in the later 1980s. Machines fly trajectories autonomously, but a human weapons officer must authorize destructive fire.</p>"},
