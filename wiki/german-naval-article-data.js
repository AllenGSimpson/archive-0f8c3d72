...
Object.assign(window.deepArticles, {
  "kriegsmarine-postwar": navalArticle({
    ...
    related:[{href:"german-submarine-force.html",kicker:"Principal striking arm",label:"German Submarine Force"},{href:"german-surface-fleet.html",kicker:"Supporting fleet",label:"German Surface Fleet"},{href:"military-technology.html",kicker:"Capability portal",label:"Military Technology"},{href:"iceland-crisis.html",kicker:"Atlantic confrontation",label:"Iceland Crisis"},{href:"germany.html",kicker:"Sovereign power",label:"Greater German Reich"}],
  ...
  "elektroboot-heritage": navalArticle({
    ...
    sections:[
      ...
      {id:"successors",title:"Successor lines",html:"<p>Type XXIV extended ocean endurance; Type XXVII supplied coastal and export service; Type XXIX pursued deep-ocean quieting; Type XXXII renewed the conventional branch. Nuclear Types XXX and XXXIII and missile Types XXXI and XXXIV changed propulsion and weapons while retaining the submerged-first premise.</p>"},
