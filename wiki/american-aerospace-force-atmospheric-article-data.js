...
Object.assign(window.deepArticles, {
  "american-aerospace-force-atmospheric-fleet": americanAerospaceAtmosphericArticle({
    ...
    canon:"The seven-aircraft high-speed register, introduction years, missions, performance, radii, ceilings, armament or equipment, the 1958 Aerospace Command origin, 1962 independent service, limited 1956 B-52A/B service in a roughly 24–48-aircraft range, absence of a mass B-52 fleet, conventional-only bomber loads, and later retreat from atmospheric strategic bombing are fixed. Broad historical manufacturer and design foundations are retained where compatible. Exact procurement programs, engines, dimensions, avionics, production totals within fixed ranges, formations, bases, operations, losses, exports, upgrades, and retirement remain open.",
    sections:[
      ...
      {id:"bombers",title:"The high-supersonic bomber branch",html:"<p>B-58A makes speed the foundation of the postwar <em>Schnellbomber</em> mission. B-70A extends that premise to Mach 3, a 6,900 km combat radius, and 14,500 kg of conventional stores. Neither aircraft carries atomic weapons, which never become part of the strategic order.</p><!-- altwwii-writer-block:start id=wb-g-20260815-u2j6b writer=g kind=revision created=2026-08-15T12:03:23-06:00 --><p>B-29 and B-36 fleets continue in reduced maritime, reconnaissance, conventional, and test work. B-47 experience informs the transition. B-52A/B enters limited service in 1956, with roughly 24–48 aircraft used for long-range reconnaissance, maritime work, guided-weapon trials, strategic exercises, and X-plane mothership missions. It does not become a mass operational bomber fleet.</p><!-- altwwii-writer-block:end -->"},
  ...
  "f-104a-starfighter": americanAerospaceAtmosphericType({
    ...
    developmentHtml:"<p>Lockheed began the F-104 family under Clarence ‘Kelly’ Johnson. The design used a slender fuselage, very thin short wings, a powerful J79-class engine, and a cannon-centered fighter layout. The divergent <a href='century-series.html'>Century-Series</a> chronology places the first flight in 1956; the registered F-104A enters Aerospace Command service in 1958.<sup class='canon-note' data-provenance='a'>[a]</sup></p>",
    ...
    related:[{href:"century-series.html",kicker:"Development generation",label:"Century Series"},{href:"american-jet-engine-industry.html",kicker:"J79 industrial base",label:"American Jet-Engine Industry"},{href:"f-108a-rapier.html",kicker:"Long-range successor",label:"F-108A Rapier"},{href:"f-94c-starfire.html",kicker:"Command contemporary",label:"F-94C Starfire"}]
  }),
  ...
  "f-108a-rapier": americanAerospaceAtmosphericType({
    ...
    developmentHtml:"<p>North American developed the Rapier concept beside the B-70 Valkyrie, sharing the J93 engine, high-temperature materials, sensors, and systems intended for sustained flight near Mach 3. XF-108 first flies in 1961. The program survives repeated cost and vulnerability challenges and enters Aerospace Force service in 1966.<sup class='canon-note' data-provenance='a'>[a]</sup></p>",
    ...
    related:[{href:"century-series.html",kicker:"Development generation",label:"Century Series"},{href:"american-jet-engine-industry.html",kicker:"J93 industrial base",label:"American Jet-Engine Industry"},{href:"f-12a-blackbird.html",kicker:"Mach 3 successor",label:"F-12A Blackbird"},{href:"b-70a-valkyrie.html",kicker:"Shared development family",label:"B-70A Valkyrie"}]
  }),
