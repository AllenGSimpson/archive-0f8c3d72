...
Object.assign(window.deepArticles,{
  "japanese-landings-singapore":singaporeBattleArticle({
    ...
    lead:"The Japanese landings on Singapore were the night crossings of the Johore Strait that established the 25th Army on the island's northwestern shore. The principal assault struck the thinly held Sarimbun sector, followed by an Imperial Guards crossing at Kranji. Once both bridgeheads survived, Japanese engineers, artillery, and infantry turned a precarious waterborne assault into the inland advance that ended British rule.",
    canon:"The historical northwestern assault plan, 5th and 18th Divisions at Sarimbun, Imperial Guards at Kranji, Australian coastal defense, deception toward the northeast, and subsequent advance are retained as the operational baseline. The setting fixes the landings in February 1942 but leaves exact alternate wave strengths, losses, timings, and the final surrender day open because formations spared from the Philippines could alter reserves and tempo.",
    sections:[
      ...
      {id:"plan",title:"The northwestern plan",html:"<p>Lieutenant General Tomoyuki Yamashita concentrated the principal crossing against the mangrove, creek, and plantation coast west of the Causeway. The 5th and 18th Divisions would land around Sarimbun, while the Imperial Guards Division would cross near Kranji after the first lodgment drew attention.</p><p>The scheme sought roads and assembly ground rather than the city itself. Once troops reached the Choa Chu Kang and Jurong approaches, they could turn southeast toward Bukit Timah.</p>"},
  ...
  "battle-of-sarimbun-beach":singaporeBattleArticle({
    ...
    lead:"The Battle of Sarimbun Beach was the first and largest Japanese crossing of the Johore Strait during the assault on Singapore. The Australian 22nd Brigade defended a broad northwestern coast cut by mangroves, creeks, and plantations. Its forward companies repelled and disrupted early landings, but repeated waves passed through gaps, separated local positions, and forced a withdrawal toward the interior.",
    canon:"The historical landing zone between Sarimbun and the Lim Chu Kang approaches, 22nd Australian Brigade defense, 5th and 18th Division assault, night crossing, local resistance, infiltration through gaps, and inland withdrawal are retained. The exact alternate hour, assault strength, company dispositions, and casualty figures remain open.",
    sections:[
  ...
  "battle-of-kranji":singaporeBattleArticle({
    ...
    sections:[
      ...
      {id:"defense",title:"Australian and volunteer defense",html:"<p>Elements of the 27th Australian Brigade held the eastern bank and approaches, while the western side included men of Dalforce, the locally raised Chinese volunteer formation. Their positions covered likely boat lanes and the river mouth.</p><p>The defenders had seen the Sarimbun crisis develop to the west but could not know whether Kranji represented a diversion or a second major assault.</p>"},
    ...
    related:[{href:"battle-of-sarimbun-beach.html",kicker:"Principal landing",label:"Battle of Sarimbun Beach"},{href:"battle-of-bukit-timah.html",kicker:"Inland objective",label:"Battle of Bukit Timah"}],
  ...
  "battle-of-pasir-panjang":singaporeBattleArticle({
    ...
    lead:"The Battle of Pasir Panjang was the defense of the southwestern ridges leading toward Singapore city, culminating in the Malay Regiment's stand at Bukit Chandu. British, Malay, and supporting troops contested the high ground against the Japanese 18th Division after Bukit Timah had fallen. The position was overwhelmed, but the resistance became one of the principal military memories of Malay service and Singapore's last days under British rule.",
    ...
    related:[{href:"battle-of-bukit-timah.html",kicker:"Preceding central battle",label:"Battle of Bukit Timah"},{href:"alexandra-hospital-massacre.html",kicker:"Atrocity after the ridge fell",label:"Alexandra Hospital Massacre"}],
