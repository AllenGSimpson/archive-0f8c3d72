...
Object.assign(window.deepArticles,{
  "japanese-landings-singapore":singaporeBattleArticle({
    ...
    related:[{href:"tomoyuki-yamashita.html",kicker:"Army commander",label:"Tomoyuki Yamashita"},{href:"battle-of-sarimbun-beach.html",kicker:"Principal first landing",label:"Battle of Sarimbun Beach"},{href:"battle-of-kranji.html",kicker:"Second crossing sector",label:"Battle of Kranji"}],
  ...
  "battle-of-sarimbun-beach":singaporeBattleArticle({
    ...
    related:[{href:"gordon-bennett.html",kicker:"Australian divisional commander",label:"Gordon Bennett"},{href:"takuro-matsui.html",kicker:"5th Division commander",label:"Takurō Matsui"},{href:"renya-mutaguchi.html",kicker:"18th Division commander",label:"Renya Mutaguchi"},{href:"japanese-landings-singapore.html",kicker:"Landing operation",label:"Japanese Landings on Singapore"},{href:"battle-of-kranji.html",kicker:"Second bridgehead",label:"Battle of Kranji"}],
  ...
  "battle-of-kranji":singaporeBattleArticle({
    ...
    sections:[
      ...
      {id:"crisis",title:"A Japanese local crisis",html:"<p>Heavy losses and confusion led Guards commander <a href='takuma-nishimura.html'>Takuma Nishimura</a> to consider or request withdrawal. The episode became evidence that the island assault could have been checked at an individual sector even after Sarimbun.</p><p><a href='tomoyuki-yamashita.html'>Yamashita's</a> headquarters instead required the division to persist while the wider battle continued west and inland.</p>"},
    ...
    related:[{href:"takuma-nishimura.html",kicker:"Guards commander",label:"Takuma Nishimura"},{href:"gordon-bennett.html",kicker:"Australian divisional commander",label:"Gordon Bennett"},{href:"battle-of-sarimbun-beach.html",kicker:"Principal landing",label:"Battle of Sarimbun Beach"},{href:"battle-of-bukit-timah.html",kicker:"Inland objective",label:"Battle of Bukit Timah"},{href:"dalforce.html",kicker:"Local volunteer defenders",label:"Dalforce"}],
  ...
  "battle-of-bukit-timah":singaporeBattleArticle({
    ...
    related:[{href:"takuro-matsui.html",kicker:"5th Division commander",label:"Takurō Matsui"},{href:"renya-mutaguchi.html",kicker:"18th Division commander",label:"Renya Mutaguchi"},{href:"battle-of-kranji.html",kicker:"Northern crossing",label:"Battle of Kranji"},{href:"battle-of-pasir-panjang.html",kicker:"Final ridge battle",label:"Battle of Pasir Panjang"}],
  ...
  "battle-of-pasir-panjang":singaporeBattleArticle({
    ...
    sections:[
      ...
      {id:"regiment",title:"The Malay Regiment",html:"<p>The 1st Battalion, Malay Regiment, fought within the brigade defense under British and Malay officers. The battalion's service made the battle a foundational military memory for postcolonial Malaya and for Singapore's Malay community.</p><p>Lieutenant <a href='adnan-saidi.html'>Adnan Saidi</a> commanded a company sector and became the best-known individual defender of the ridge.</p>"},
