...
| [Bildschrift 83](software-specs/languages/de/bildschrift-83/manifest.json) | windows, drawing, animation and games | event-driven scene/window objects, sprites, paths, text and sound resources; visual editor serializes a textual Zivil-Planform-bound module |
| [Nachricht 84](software-specs/languages/de/nachricht-84/manifest.json) | messages and distributed programs | typed processes, bounded mailboxes, send/receive/select, timeout, hierarchical service names; at-most-once local delivery and explicitly acknowledged remote delivery |
| [Schnur 80](software-specs/languages/de/schnur-80/manifest.json) | electronics clubs and instruments | 16-bit direct-threaded postfix dictionary; dual stacks, interactive transactional compilation, explicit device capabilities, and relocatable checked images |
| [Bericht 81](software-specs/languages/de/bericht-81/manifest.json) | small-business reports | versioned record snapshots, stable sorting, nested groups, exact decimal totals, deterministic pagination, and atomically published replayable spools |
| [Spielsatz 81](software-specs/languages/de/spielsatz-81/manifest.json) | cassette games | deterministic 50-Hz state tables over a compact 48-opcode stack VM, sprites/controllers/sound, checked portable and specified self-modifying unsafe profiles |
| [Satzwerk 81](software-specs/languages/de/satzwerk-81/manifest.json) | publishing and text macros | bounded Z12 stream patterns with longest-match captures, transactional actions, record merge, staged conversion, and canonical typesetting events |
| [Schaltfolge 82](software-specs/languages/de/schaltfolge-82/manifest.json) | civilian industrial control | fixed scan state transitions, typed device snapshots, bounded timers/actions, atomic prioritized outputs, watchdog and latched safe shutdown; explicitly noncertified |
| [Wortbrücke 82](software-specs/languages/de/wortbruecke-82/manifest.json) | translation and localization | protected UZ16 tokenization, finite morphology/features, bounded phrase transfer, mandatory terminology, canonical ambiguity resolution, and provenance-ledger review |
| [Datenfrage 82](software-specs/languages/de/datenfrage-82/manifest.json) | small databases | interactive read-only queries over sequential/indexed/hierarchical files, explicit missing values, stable navigation bags, bounded work, and canonical typed results |
| [Netzblatt 83](software-specs/languages/de/netzblatt-83/manifest.json) | bulletin boards and information services | negotiated terminal pages, validated forms, role-checked transactional actions, durable boards, quotas, longest-prefix routes, and application-acknowledged messages |
| [Werkstatt 84](software-specs/languages/de/werkstatt-84/manifest.json) | professional build automation | hash-pinned tools/includes, pure graph macros and pattern rules, signature rebuilds, deterministic parallel scheduling, staged atomic outputs, cache, and reproducible records |
| [Kleinplan 80](software-specs/languages/de/kleinplan-80/manifest.json) | magazine and 8–12 KiB micros | strict integer-only Kurzplan subset with 52 variables, one-dimensional arrays, shallow control stack, compact strings, optional point graphics/tone, and fork-safe token images |
| [Heimplan-S](software-specs/languages/de/heimplan-s-80/manifest.json) | S-family home computer | Kurzplan ROM dialect with a 320×200 four-color bitmap, deterministic software shapes/fill, three tone voices plus noise, and S-specific tokens/resources |
| [Heimplan-T](software-specs/languages/de/heimplan-t-80/manifest.json) | competing T-family home computer | Kurzplan ROM dialect with tile maps, programmable patterns, 16 sprites/collision latches, staged frame commits, envelopes, and token meanings incompatible with S |
| [Rechentafel 80](software-specs/languages/de/rechentafel-80/manifest.json) | programmable engineering calculators | 12-digit BCD expressions, engineering units, input/formula/delayed table columns, deterministic recalculation, statistics/regression, printer listings, and RT80 cards |
| [Formblatt 81](software-specs/languages/de/formblatt-81/manifest.json) | office and municipal forms | typed 80×24 data-entry screens, transactional record validation, Lehrplan callbacks, A4 decimillimetre layouts, canonical form images, and atomic print spools |
| [Zeichenweg 81](software-specs/languages/de/zeichenweg-81/manifest.json) | school turtle geometry | dynamically typed procedures over exact Q16.16 motion, retained vector paths, deterministic clipped Bresenham rasterization, verified bytecode images, and portable plot files |
| [Klangfolge 82](software-specs/languages/de/klangfolge-82/manifest.json) | home-computer music and sound | portable 384-PPQN scores, bounded patterns and four monophonic voices, exact rational envelopes, HPS80/HPT80/K60 timing profiles, verified schedule images, and canonical register traces |
| [Gerätewort 82](software-specs/languages/de/geraetewort-82/manifest.json) | civilian laboratories | signed semantic device profiles, typed decimal physical units, calibrated reads, atomic register groups, absolute polling/periodic schedules, verified experiment bytecode, and reproducible traces |
| [Baukasten 83](software-specs/languages/de/baukasten-83/manifest.json) | visual structured-programming education | 24 typed block kinds over a strict Lehrplan profile, contextual palettes and holes, atomic tree editing, canonical authoritative Lehrplan source, and verified parent-only preview execution |
| [Kartenwerk 83](software-specs/languages/de/kartenwerk-83/manifest.json) | cadastral, railway, and municipal mapping | canonical vector/record datasets, exact millimetre survey geometry and topology, rational sheet scaling/clipping, deterministic styling and labels, verified map images, and semantic plot interchange |
| [Reihe 83](software-specs/languages/de/reihe-83/manifest.json) | university array-language research | pure finite numeric and character arrays of rank 0–8, explicit shape contracts and axis primitives, deterministic reductions/scans/products, canonical semantic trees, and direct verified ZPF modules without device services |
| [Beweis 83](software-specs/languages/de/beweis-83/manifest.json) | university theorem work | classical many-sorted first-order proofs with equality, typed functional proof constructors, explicit axiom trust hashes, bounded occurs-check search, a 21-rule independent kernel, and canonical portable certificates |
| [Handelssatz 84](software-specs/languages/de/handelssatz-84/manifest.json) | retail and inventory packages | exact tax-inclusive prices and returns, nine atomic inventory workflows, canonical locking/idempotence, hash-pinned Formblatt/Bericht assets, hash-chained snapshots/journals, and semantic migration export |
| [Fernbild 84](software-specs/languages/de/fernbild-84/manifest.json) | videotex and remote graphics | fixed 320×240 sixteen-color pages, 8×10 semantic text cells, bounded lines/boxes/mosaics/icons, server-side forms and lists, verified interaction code, and reliable atomic page transport |
